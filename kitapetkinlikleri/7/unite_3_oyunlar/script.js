...
function initPickers() {
    ...
    document.querySelectorAll('.picker-column').forEach(col => {
        col.addEventListener('scroll', () => {
            const firstItem = col.querySelector('.picker-item');
            ...
            if (col.scrollTop > (originalCount + 1) * itemHeight) { 
                col.scrollTop -= originalCount * itemHeight; 
            }
            if (col.scrollTop < 1 * itemHeight) { 
                col.scrollTop += originalCount * itemHeight; 
            }
        ...
        col.addEventListener('click', (e) => {
            ...
            const clickedItem = e.target.closest('.picker-item');
