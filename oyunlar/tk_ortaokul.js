        ...
        "5": [
            { yil: "2025-2026", onek: "", u: [
                { no: 1, ad: "Merhaba", ar: "مَرْحَبًا", d: [
                    ["5_1_1", "Arap Harfleri ve Sesler", "اَلحُرُوفُ العَرَبِيَّة وَالصَّوَائِت"],
        ...
        "6": [
            { yil: "2026-2027", onek: "y2627/", u: [
                { no: 1, ad: "Akrabalarım", ar: "أَقارِبي", d: [
                    ["6_1_1", "Akrabalar", "اَلأَقارِب"],
                    ["6_1_2", "Meslekler", "اَلمِهَن"]
                ] },
                { no: 2, ad: "Haydi Okula", ar: "هَيّا إلى المَدْرَسَة", d: [
                    ["6_2_1", "Okulun Bölümleri ve Araçları", "أَقْسامُ المَدْرَسَة وَأَدَواتُها"],
                    ["6_2_2", "Sıra Sayıları", "اَلأَعْدادُ التَّرْتيبِيَّة"]
                ] },
                { no: 3, ad: "Vücudum", ar: "جِسْمي", d: [
                    ["6_3_1", "Organlar", "اَلأَعْضاء"],
                    ["6_3_2", "Hisler ve Duygular", "اَلإِحْساس وَالْمَشاعِر"]
                ] },
                { no: 4, ad: "Bu Hafta Hava Nasıl?", ar: "كَيْف الجَوّ هَذا الأُسْبوع؟", d: [
                    ["6_4_1", "Hava Durumu", "اَلأَحْوالُ الجَوِّيَّة"],
                    ["6_4_2", "Renkler", "اَلأَلْوان"]
                ] }
            ] },
            { yil: "2025-2026", onek: "", u: [
                { no: 1, ad: "Günlük Hayat", ar: "الحَياةُ اليَوْمِيَّة", d: [
                ...
                { no: 3, ad: "Sağlık", ar: "الصِّحَّة", d: [
                    ["6_3_1", "Vücut Organları", "أَعْضاءُ الجِسْم"],
                    ["6_3_2", "Hastanede", "في المُسْتَشْفى"],
                    ["6_3_3", "Temizlik", "النَّظافَة"]
                ] },
                { no: 4, ad: "Kıyafetler", ar: "المَلابِس", d: [
                    ["6_4_1", "Mevsimler", "الفُصول"],
                    ["6_4_2", "Kışlık Kıyafetler", "المَلابِسُ الشِّتَوِيَّة"],
                    ["6_4_3", "Yazlık Kıyafetler", "المَلابِسُ الصَّيْفِيَّة"]
                ] },
                { no: 5, ad: "Kutsal Mekânlar", ar: "الأَماكِنُ المُقَدَّسَة", d: [
                    ["6_5_1", "Mekke-i Mükerreme'de", "في مَكَّة المُكَرَّمَة"],
                    ["6_5_2", "Medine-i Münevvere'de", "في المَدينَةِ المُنَوَّرَة"],
                    ["6_5_3", "Kudüs-i Şerif'te", "في القُدْس الشَّريف"]
                ] },
        ...
        "7": [
            ...
            { yil: "2027-2028", onek: "", u: [
                { no: 1, ad: "Bugün Ne Yaptım?", ar: "ماذا فَعَلْتُ اليَوْمَ؟", d: [
                    ["7_1", "Günlük Etkinlikler ve Saatler", "الأَنْشِطَةُ اليَوْمِيَّة وَالسّاعات"]
                ] },
                { no: 2, ad: "Alışveriş Zamanı", ar: "وَقْتُ التَّسَوُّق", d: [
                    ["7_2", "Alışveriş, Miktar ve Sayılar", "التَّسَوُّق وَالكَمِّيّات وَالأَعْداد"]
                ] },
                { no: 3, ad: "Nereye Seyahat Edelim?", ar: "إِلى أَيْن نُسافِرُ؟", d: [
                    ["7_3", "Ulaşım ve Seyahat", "المُواصَلات وَالسَّفَر"]
                ] },
        ...
        "8": [
            { yil: "2026-2027", onek: "", u: [
                { no: 1, ad: "Etkinlikler", ar: "الأَنْشِطَة", d: [
                    ...
                    ["8_1_2", "Tiyatro", "المَسْرَحِيَّة"],
                    ["8_1_3", "Gezi", "التَّجَوُّل"]
                ] },
                { no: 2, ad: "Kültür ve Sanat", ar: "الثَّقافَة وَالفَنّ", d: [
                    ["8_2_1", "Edebiyat", "الأَدَب"],
                    ["8_2_2", "Kitap Fuarında", "في مَعْرِضِ الكِتاب"],
                    ["8_2_3", "El Sanatları", "الفُنونُ اليَدَوِيَّة"]
                ] },
                { no: 3, ad: "Değerlerim", ar: "قِيَمي", d: [
                    ["8_3_1", "Arkadaşlık", "الصَّداقَة"],
                    ["8_3_2", "Yardımlaşma", "التَّعاوُن"],
                    ["8_3_3", "Bayramlar", "الأَعْياد"]
                ] },
                { no: 4, ad: "Doğa", ar: "الطَّبيعَة", d: [
                    ["8_4_1", "Çevrenin Önemi", "أَهَمِّيَّةُ البِيئَة"],
                    ["8_4_2", "Hayvan Sevgisi", "حُبُّ الحَيَوانات"],
                    ["8_4_3", "Doğal Afetler", "الكَوارِثُ الطَّبيعِيَّة"]
                ] },
                { no: 5, ad: "Spor", ar: "الرِّياضَة", d: [
                    ["8_5_1", "Sporun Tarihi", "تاريخُ الرِّياضَة"],
                    ["8_5_2", "Sporun Önemi", "أَهَمِّيَّةُ الرِّياضَة"],
                    ["8_5_3", "Spor Türleri", "أَنْواعُ الرِّياضَة"]
                ] },
                { no: 6, ad: "Okula Veda", ar: "وَداعُ المَدْرَسَة", d: [
                    ["8_6_1", "Mezuniyet", "التَّخَرُّج"],
                    ["8_6_2", "Arkadaşlara Veda", "وَداعُ الأَصْدِقاء"],
                    ["8_6_3", "Yaz Tatili", "العُطْلَةُ الصَّيْفِيَّة"]
                ] }
            ] }
        ]
    };
