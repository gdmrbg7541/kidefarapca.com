...
const KONULAR = [
  ...
  { id: "sinif8", ad: "8. Sınıf", pdf: "", sorular: [
    ...
    {"id": 20004, "tip": "cumle", "zorluk": 1, "soru": "Bu cümlenin anlamı nedir?", "secenekler": ["Spor salonundan okula nasıl giderim?", "Akşam saat beşte başlayacak.", "geniş — dar", "Adam dedi: «On yıl önce de kırk demiştin.»"], "dogru": 0, "arapca": "كَيْفَ أَذْهَبُ مِنَ الصّالَة الرِّياضِيَّة إلى المَدْرَسَة؟"},
    ...
    {"id": 20008, "tip": "cumle", "zorluk": 1, "soru": "Bu cümlenin anlamı nedir?", "secenekler": ["Merhaba Sümeyye, nereye gidiyorsun?", "Evet, okulun temizliğini korumamız gerekir, çünkü orası ikinci evimizdir.", "Arkadaşlar arasında saygı önemlidir.", "Diyalog Furkan ile annesi arasında geçiyor."], "dogru": 0, "arapca": "مَرْحَبًا سُمَيَّة، إلى أَيْنَ أنتِ ذاهِبَة؟"},
    ...
    {"id": 20028, "tip": "cumle", "zorluk": 1, "soru": "«Meral sporu seviyor, bu yüzden spor kulübünü seçiyor.» cümlesinin Arapçası hangisi?", "secenekler": ["أنا أُريدُ مِنْك هذا المِصْباح.", "كَيْفَ خَديجَة سَتُشارِكُ في تَنْظيف الصَّفّ؟", "أَهْلًا وسَهْلًا.", "مَرال تُحِبُّ الرِّياضَة لِذَلِكَ تَخْتارُ نادي الرِّياضَة."], "dogru": 3, "arSecenek": true},
    ...
    {"id": 20031, "tip": "cumle", "zorluk": 2, "soru": "«Arkadaşlarımı çok severim, çünkü arkadaşım mutluluğumun kaynağıdır.» cümlesinin Arapçası hangisi?", "secenekler": ["أُحِبُّ صَديقاتي كَثيرًا، لِأَنَّ صَديقَتي مَصْدَر سَعادَتي.", "إِذَنْ قُلْ لي أَيْنَ مَرْكَزُ الأَرْضِ؟", "أَكْتُبُ كُتُبي.", "اِذْهَبْ إلى الأَمام، واتَّجِهْ نَحْوَ يَسارِكَ، ثُمَّ اِتَّجِهْ نَحْوَ اليَمين، سَتَجِدُهُ أمامَكَ."], "dogru": 0, "arSecenek": true},
    {"id": 20032, "tip": "cumle", "zorluk": 1, "soru": "«Arkadaşım Elif tiyatro kulübünü seçiyor.» cümlesinin Arapçası hangisi?", "secenekler": ["أَهْلًا وسَهْلًا. هذا فَنّ الخَزَف التُّرْكِيّ.", "لِأَنَّني أُحِبُّ كُرَة القَدَم، وَأَنا مَسْؤول عَنِ الأَدَوات الرِّياضِيَّة.", "القَرْيَة", "صَديقَتي أَليف تَخْتارُ نادي المَسْرَحِيَّة."], "dogru": 3, "arSecenek": true},
    ...
    {"id": 20058, "tip": "cumle", "bicim": "bosluk", "zorluk": 1, "soru": "Boşluğa gelecek kelimeyi seç: «قَديم – ____»", "secenekler": ["أَيْنَ؟", "أَمْس.", "أَبَدًا.", "جَديد"], "dogru": 3, "arSecenek": true},
    ...
    {"id": 20066, "tip": "cumle", "bicim": "dogruyanlis", "zorluk": 1, "soru": "«Sen müziği seviyorsun, bu yüzden müzik kulübünü seçiyorsun.» çevirisi doğru mu?", "secenekler": ["Doğru", "Yanlış"], "dogru": 1, "arapca": "المَكْتَبَة بَعيدَة عَنِ البَيْت."},
