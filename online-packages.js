function renderOnlinePackagesGrid() {
    ...
    appState.onlinePackages.forEach(pkg => {
        ...
        // Satın alınmışsa KİLİTLEME/SOLDURMA yok; sadece "Sahipsiniz" etiketi görünür.

        let checkIconClass = (isSelected || isPurchased) ? 'fas fa-check-circle' : 'far fa-circle';
        ...
        let html = `
            ...
            ${isPurchased ? '' : `<div style="margin-right: 15px; font-weight: bold; color: #F39C12; font-size: 1.2rem;">
                ${(typeof pkg.price === 'number' ? pkg.price.toLocaleString('tr-TR') : pkg.price)} ₺
            </div>`}
