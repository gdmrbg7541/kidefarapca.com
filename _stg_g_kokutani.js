...
"ح-ك-م": { "root": ["ح", "ك", "م"], "words": [ { "text": "حَاكِم 🧑‍⚖️" }, { "text": "حَكِيم 👨‍⚕️" }, { "text": "مَحْكُوم ⛓️" }, { "text": "حَكَم ⚽" }, { "text": "حُكْم 📜" } ] },
            ...
            "ع-ل-م": { "root": ["ع", "ل", "م"], "words": [ { "text": "عَالِم 🎓" }, { "text": "تَعْلِيم 🧑‍🏫" }, { "text": "مُعَلِّم 👨‍🏫" }, { "text": "عِلْم 🧠"}, { "text": "مَعْلُوم 📌"} 
] },
...
{ "text": "حَسَن 😊" }, { "text": "حُسَيْن 🧒" }, { "text": "أَحْسَن 🌟" }, { "text": "إِحْسَان ❤️" }, { "text": "تَحْسِين 👍" } ] },
            "ج-ه-ل": { "root": ["ج", "ه", "ل"], "words": [ { "text": "جَاهِل 🤷" }, { "text": "جَاهِلِيَّة 🏺" }, { "text": "مَجْهُول ❓" }, { "text": "جُهَلَاء 👥" } ] },
...
[ { "text": "سَلَام 🕊️" }, { "text": "سَلَامَة 🛡️" }, { "text": "سَالِم ✅" }, { "text": "إِسْلَام ☪️" }, { "text": "تَسْلِيم 🤝" } ] },
        ...
        "د-خ-ل": { "root": ["د", "خ", "ل"], "words": [ { "text": "دَاخِل ➡️" }, { "text": "دَاخِلِيَّة 🏥" }, { "text": "إِدْخَال 📥" }, { "text": "مُدَاخَلَة ✋" } ] },
...
"text": "قَدَر ⚡" } ] },
            ...
            "ر-س-ل": { "root": ["ر", "س", "ل"], "words": [ { "text": "رِسَالَة 📜" }, { "text": "رَسُول 🗣️" }, { "text": "إِرْسَالِيَّة 🧾" }, { "text": "مُرْسَل 📨" } ] },
...
"text": "نَصْر 🏆" }, { "text": "نُصْرَة ✌️" }, { "text": "نَاصِر 🛡️" }, { "text": "مَنْصُور 🥇" } ] },
     ...
     "خ-ل-ص": { "root": ["خ", "ل", "ص"], "words": [ { "text": "خَالِص 💧" }, { "text": "إِخْلَاص 💖" }, { "text": "مُخْلِص 😊" } ] },
            ...
            "ج-م-ع": { "root": ["ج", "م", "ع"], "words": [ { "text": "جَمْع 👥" }, { "text": "جَمْعِيَّة 🏛️" }, { "text": "جَمَاعة 👨‍👩‍👧‍👦" }, { "text": "جَامِعَة 🕌" }, { "text": "اِجْتِمَاع 🤝" } ] },
            "ح-م-د": { "root": ["ح", "م", "د"], 
