    ...
    var VERI = {
        ...
        "5": {
            ...
            haftalar: [
                ...
                'Aile bireyleri: أَب، أُمّ، أَخ، أُخْت، جَدّ، جَدَّة',
                'İyelik zamirleri: كِتَابِي، كِتَابُكَ، كِتَابُهُ',
                '1. dönem genel tekrarı ve değerlendirme',
                'Meslekler: مُعَلِّم، طَبِيب، مُهَنْدِس، شُرْطِيّ',
        ...
        "6": {
            ...
            haftalar: [
                ...
                'Yakın akrabalar: عَمّ، عَمَّة، خال، خالَة — soru kalıbı مَنْ هَذا؟ / مَنْ هَذِهِ؟',
                ...
                'Muttasıl zamirlerin genişletilmesi: ـنا، ـكُم، ـهُم، ـهُنَّ (أُسْرَتُنا، أَقارِبُنا)',
                'Akrabamı tanıtıyorum: هَذا عَمّي، هُوَ تاجِر — müzekker-müennes uyumu',
                'Akraba ziyareti diyaloğu: أَيْن يَسْكُنُ عَمُّكَ؟ — şehir adlarıyla في; sıla-i rahim',
                ...
                'Ders adları: الرِّياضِيّات، العُلوم، اللُّغَةُ العَرَبِيَّة، التّاريخ، الجُغْرافْيا',
                'Haftanın günleri ve ders programı: الأَحَد، الاِثْنَيْن، الثُّلاثاء، الأَرْبِعاء، الخَميس',
                'Muzâri fiile giriş: أَذْهَبُ، أَدْرُسُ، أَكْتُبُ، أَقْرَأُ — صَباحًا، مَساءً، يَوْمِيًّا',
                ...
                'Neren ağrıyor?: يُؤْلِمُني رَأْسي، عِنْدي أَلَم في… — أَلَم، صُداع، حَرارَة، كُحَّة',
                ...
                'Hava nasıl?: جَوّ، حارّ، بارِد، مُعْتَدِل، دافِئ — كَيْف الجَوُّ اليَوْمَ؟',
                'Hava olayları: مَطَر، ثَلْج، رِياح، سَحاب، رَعْد، بَرْق — السَّماءُ صافِيَة / غائِمَة',
                'Hava durumu bülteni ve sembolleri: دَرَجَةُ الحَرارَة، اليَوْم، غَدًا، أَمْسِ',
                'Mevsimler: الرَّبيع، الصَّيْف، الخَريف، الشِّتاء — في فَصْلِ الصَّيْفِ yapısı',
                'Hangi mevsimi seviyorum?: أُحِبُّ / لا أُحِبُّ — لِماذا؟ لِأَنَّ…',
        ...
        "7": {
            ...
            haftalar: [
                ...
                'Zaman zarfları: صَبَاحًا، مَسَاءً، يَوْمِيًّا',
                'Bir günümü anlatma: ثُمَّ، بَعْدَ ذَلِكَ ile metin kurma',
                '1. Ünite değerlendirmesi: bugün ne yaptım?',
                'Alışveriş mekânları: سُوق، مَتْجَر، صَيْدَلِيَّة',
                ...
                'Yön sorma: إِلَى أَيْن؟ / مِنْ أَيْن؟',
                ...
                'Soru edatlarının toplu tekrarı (هَلْ، مَا، مَنْ، أَيْن، مَتَى، كَيْف، كَمْ)',
        ...
        "8": {
            ...
            haftalar: [
                ...
                'Görüş bildirme: أَظُنُّ، فِي رَأْيِي',
                '3. Ünite değerlendirmesi: iletişim günlüğüm',
                'Meslekler: geniş meslek dağarcığı',
                'Meslek seçimi ve sebep bildirme (لِأَنَّ)',
        ...
        "9": {
            ...
            haftalar: [
                ...
                'Selamlaşma ifadeleri: السَّلامُ عَلَيْكُم، أَهْلًا وَسَهْلًا',
                ...
                'Meslekler: مُعَلِّم، طَبِيب، مُهَنْدِس، مُحَامٍ',
        ...
        "10": {
            ...
            haftalar: [
                ...
                'Beğeni ve tercih: أُفَضِّلُ، أَهْتَمُّ بِـ',
                ...
                'Sebep–sonuç bağlaçları: لِأَنَّ، لِذَلِكَ',
