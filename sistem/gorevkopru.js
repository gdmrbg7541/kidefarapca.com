...
(function () {
    ...
    function sureKur() {
        ...
        /* ILK kayit cabuk dussun (kisa ziyaretler de iz biraksin), sonrasi
           normal kalp atisi araligiyla surer. */
        setTimeout(atis, Math.min(15000, sure.aralikMs));
        setInterval(atis, sure.aralikMs);
