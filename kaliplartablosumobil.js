...
function updateSuffixHighlights(currentBox) {
    ...
    const availableSuffixes = Object.keys(eggObj).filter(k => 
        k !== 'base' && k !== 'ornek' && k !== 'cekimi' && k !== 'suggestsPlus' && k !== 'tip' && k !== 'isDictOnly' && k !== 'cogulId' && k !== 'tekilId' && k !== 'autoGenerated'
    );
...
function checkWordEasterEgg(boxElement, incomingSuffix = null, silentEmoji = false, isInitialLoad = false) {
    ...
    if (activeSuffix) {
        for (let k in eggObj) {
            if (k !== 'base' && k !== 'ornek' && k !== 'cekimi' && k !== 'suggestsPlus' && k !== 'tip' && k !== 'isDictOnly' && k !== 'cogulId' && k !== 'tekilId' && k !== 'autoGenerated') {
    ...
    // ===============================================================
    let hasSuffixes = Object.keys(eggObj).some(k => k !== 'base' && k !== 'ornek' && k !== 'cekimi' && k !== 'suggestsPlus' && k !== 'tip' && k !== 'isDictOnly' && k !== 'cogulId' && k !== 'tekilId' && k !== 'autoGenerated');
        ...
        for (const [rootKey, rootData] of Object.entries(typeof sozlukVerileri !== 'undefined' ? sozlukVerileri : {})) {
            ...
            for (const [originalKalipKey, originalKalipData] of Object.entries(rootData)) {
                ...
                for (const suffix in originalKalipData) {
                    if (suffix !== 'base' && suffix !== 'ornek' && suffix !== 'cekimi' && suffix !== 'suggestsPlus' && suffix !== 'tip' && suffix !== 'isDictOnly' && suffix !== 'cogulId' && suffix !== 'tekilId' && suffix !== 'autoGenerated') {
