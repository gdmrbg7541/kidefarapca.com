const allWords = [
    ...
    { tr: "Abdest alıyorum", ar: "أَتَوَضَّأُ" },
    { tr: "Namaz kılıyorum", ar: "أُصَلِّي" },
    ...
    { tr: "Zeytin", ar: "الزَّيْتون" },
    { tr: "Peynir", ar: "الجُبْن" },
    { tr: "Süt", ar: "الحَليب" },
    { tr: "Et", ar: "اللَّحْم" },
    { tr: "Pirinç / Pilav", ar: "الأُرْز" },
    { tr: "Kahve", ar: "القَهْوَة" },
    { tr: "Balık", ar: "السَّمَك" },
    { tr: "Salata", ar: "السَّلَطَة" },
    { tr: "Meyve suyu", ar: "العَصير" },
    { tr: "Bal", ar: "العَسَل" },
    { tr: "Tereyağı", ar: "الزُّبْدَة" },
    { tr: "Tavuk", ar: "الدَّجاج" },
    { tr: "Ekmek", ar: "خُبْز" },
    { tr: "Çay", ar: "الشّاي" },
    ...
    { tr: "Cumartesi", ar: "السَّبْت" },
    { tr: "Çarşamba", ar: "الأَرْبِعاء" },
    { tr: "Salı", ar: "الثُّلاثاء" },
