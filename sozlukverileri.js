const sozlukVerileri = {
    ...
    "طالب": {
        "isDictOnly": true,
        "tekil": { 
            base: { emoji: "👨‍🎓", arText: "طالِب", trText: "Öğrenci" }
        },
        "cogul": { 
            base: { emoji: "👨‍🎓", arText: "طُلّاب", trText: "Öğrenciler" }
        }
    },
    ...
    "معلم": {
        "isDictOnly": true,
        "tekil": { 
            base: { emoji: "👨‍🏫", arText: "مُعَلِّم", trText: "Öğretmen" }
        },
        "cogul": { 
            base: { emoji: "👨‍🏫", arText: "مُعَلِّمون", trText: "Öğretmenler" }
        }
    },
    ...
    // ==================================================================
    // SAYILAR (1-10) (الأرقام)
    // ==================================================================
    "واحد": {
        "isDictOnly": true,
        "tekil": { base: { emoji: "1️⃣", arText: "وَاحِد", trText: "Bir (1)." } }
    },
    "اثنان": {
        "isDictOnly": true,
        "tekil": { base: { emoji: "2️⃣", arText: "اِثْنَان", trText: "İki (2)." } }
    },
    "ثلاثة": {
        "isDictOnly": true,
        "tekil": { base: { emoji: "3️⃣", arText: "ثَلَاثَة", trText: "Üç (3)." } }
    },
    "أربعة": {
        "isDictOnly": true,
        "tekil": { base: { emoji: "4️⃣", arText: "أَرْبَعَة", trText: "Dört (4)." } }
    },
    "خمسة": {
        "isDictOnly": true,
        "tekil": { base: { emoji: "5️⃣", arText: "خَمْسَة", trText: "Beş (5)." } }
    },
    "ستة": {
        "isDictOnly": true,
        "tekil": { base: { emoji: "6️⃣", arText: "سِتَّة", trText: "Altı (6)." } }
    },
    "سبعة": {
        "isDictOnly": true,
        "tekil": { base: { emoji: "7️⃣", arText: "سَبْعَة", trText: "Yedi (7)." } }
    },
    "ثمانية": {
        "isDictOnly": true,
        "tekil": { base: { emoji: "8️⃣", arText: "ثَمَانِيَة", trText: "Sekiz (8)." } }
    },
    "تسعة": {
        "isDictOnly": true,
        "tekil": { base: { emoji: "9️⃣", arText: "تِسْعَة", trText: "Dokuz (9)." } }
    },
    "عشرة": {
        "isDictOnly": true,
        "tekil": { base: { emoji: "🔟", arText: "عَشَرَة", trText: "On (10)." } }
    },
