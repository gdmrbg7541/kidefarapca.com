/* ============================================================
   ...
   YENİ BAŞLIK EKLEMEK
      konular dizisine bir satır yaz:
        { id:'ornek', ad:'Türkçe Ad', ar:'العَرَبِيَّة',
    ...
    konular: [
           ...
           --------------------------------------------------------- */
        {
            ...
            words: [
                ...
                { tr: 'Doktor',      ar: 'الطَّبيب',
                  lh: { mis: 'الدُّكْتور', sam: 'الحَكيم', hic: 'الدُّكْتور', kor: 'الدُّكْتور', irk: 'الدُّكْتور', mag: 'الطْبيب' } },
                ...
                { tr: 'Eczane',      ar: 'الصَّيْدَلِيَّة',
                  lh: { mis: 'الأَجْزَخانَة', sam: 'الصَّيْدَلِيِّة', hic: 'الصَّيْدَلِيَّة', kor: 'الصَّيْدَلِيَّة', irk: 'الصَّيْدَلِيَّة', mag: 'الفَرْماسْيان' } },
                { tr: 'İlaç',        ar: 'الدَّواء',
                  lh: { mis: 'الدَّوا', sam: 'الدَّوا', hic: 'الدَّوا', kor: 'الدَّوا', irk: 'الدَّوا', mag: 'الدْوا' } },
                { tr: 'Ateş',        ar: 'الحَرارَة',
                  lh: { mis: 'السُّخونِيَّة', sam: 'الحَرارَة', hic: 'الحَرارَة', kor: 'الحَرارَة', irk: 'الحَرارَة', mag: 'السْخانَة' } },
            ...
            sentence: [
                { words: [
                    { tr: 'Sağlık',       order: 1, ar: 'الصِّحَّةُ',
                  lh: { mis: 'الصِّحَّة', sam: 'الصِّحَّة', hic: 'الصِّحَّة', kor: 'الصِّحَّة', irk: 'الصِّحَّة', mag: 'الصِّحَّة' } },
                ...
                { words: [
                  ...
                  lh: { mis: 'النَّهارْدَه.', sam: 'اليَوْم.', hic: 'اليَوْم.', kor: 'اليَوْم.', irk: 'اليَوْم.', mag: 'اليوم.' } },
                    { tr: 'kendimi',      order: 2, ar: 'بِخَيْرٍ',
                  lh: { mis: 'كُوَيِّس', sam: 'مْنيح', hic: 'بِخير', kor: 'زين', irk: 'زين', mag: 'لاباس' } },
                ...
                { words: [
                    { tr: 'Doktora',      order: 2, ar: 'إِلى الطَّبيبِ.',
                  lh: { mis: 'لِلدُّكْتور.', sam: 'عَالحَكيم.', hic: 'لِلدُّكْتور.', kor: 'لِلدُّكْتور.', irk: 'لِلدُّكْتور.', mag: 'لْلطْبيب.' } },
                ...
                { words: [
                  ...
                  lh: { mis: 'كَشَف', sam: 'فَحَص', hic: 'فَحَص', kor: 'فَحَص', irk: 'فَحَص', mag: 'فْحَص' } },
                    { tr: 'hastayı',      order: 2, ar: 'الطَّبيبُ',
                  lh: { mis: 'الدُّكْتور', sam: 'الحَكيم', hic: 'الدُّكْتور', kor: 'الدُّكْتور', irk: 'الدُّكْتور', mag: 'الطْبيب' } },
                    { tr: 'muayene etti.', order: 3, ar: 'المَريضَ.',
                  lh: { mis: 'العَيّان.', sam: 'المَريض.', hic: 'المَريض.', kor: 'المَريض.', irk: 'المَريض.', mag: 'المْريض.' } }
                ] },
                { words: [
                    { tr: 'İlacı',        order: 2, ar: 'الدَّواءَ',
                  lh: { mis: 'الدَّوا', sam: 'الدَّوا', hic: 'الدَّوا', kor: 'الدَّوا', irk: 'الدَّوا', mag: 'الدْوا' } },
                ...
                { words: [
                    { tr: 'Spor',         order: 2, ar: 'الرِّياضَةُ',
                  lh: { mis: 'الرِّياضَة', sam: 'الرِّياضَة', hic: 'الرِّياضَة', kor: 'الرِّياضَة', irk: 'الرِّياضَة', mag: 'الرِّياضَة' } },
            ...
            dialog: [
                {
                  ...
                  lh: { mis: 'وَعَنْدي سُخونِيَّة.', sam: 'وَعِنْدي حَرارَة.', hic: 'وَعِنْدي حَرارَة.', kor: 'وَعِنْدي حَرارَة.', irk: 'وَعِدّي حَرارَة.', mag: 'وَعَنْدي السْخانَة.' } }
                    ]
                },
                {
                    p1: [
                  ...
                  lh: { mis: 'لي', sam: 'إِلي', hic: 'لي', kor: 'لي', irk: 'إِلي', mag: 'لِيَّ' } },
                ...
                },
                {
                  ...
                  lh: { mis: 'مُتْشَكِّر،', sam: 'مِرْسي إِلَك،', hic: 'مَشْكور،', kor: 'مَشْكور،', irk: 'شُكْرًا إِلَك،', mag: 'شُكْرًا لِيك،' } },
                        { tr: 'sen de sağlıklı ol.', order: 2, ar: 'وَأَنْتَ بِصِحَّةٍ وَعافِيَةٍ.',
                  lh: { mis: 'وَإِنْتَ بِصِحَّة وَعافْيَة.', sam: 'وَإِنْتَ بْصِحَّة وَعافْيِة.', hic: 'وَإِنْتَ بِصِحَّة وَعافْيَة.', kor: 'وَإِنْتَ بِصِحَّة وَعافْيَة.', irk: 'وَإِنْتَ بْصِحَّة وَعافْيَة.', mag: 'وَنْتَ بْصِحَّة وَراحَة.' } }
                    ]
                }
            ]
        },
        ...
        /* --- Diğer alanlar (içerik bekliyor) --- */
        {
            ...
            ad: 'Eğitim', ar: 'التَّعْليم',

            words: [
                { tr: 'Eğitim', ar: 'التَّعْليم' },
                { tr: 'Öğrenci', ar: 'الطّالِب' },
                { tr: 'Öğretmen', ar: 'المُعَلِّم', /*L*/ lh: { mis: 'المُدَرِّس', sam: 'الأُسْتاذ', hic: 'الأُسْتاذ', kor: 'الأُسْتاذ', irk: 'الأُسْتاذ', mag: 'الأُسْتاذ' } },
                { tr: 'Okul', ar: 'المَدْرَسَة', /*L*/ lh: { mag: 'لِمْدْرَسَة' } },
                { tr: 'Üniversite', ar: 'الجامِعَة' },
                { tr: 'Ders', ar: 'الدَّرْس' },
                { tr: 'Sınav', ar: 'الاِمْتِحان' },
                { tr: 'Kitap', ar: 'الكِتاب' },
                { tr: 'Kütüphane', ar: 'المَكْتَبَة' },
                { tr: 'Diploma', ar: 'الشَّهادَة' },
            ...
            sentence: [
                { words: [
                    { tr: 'Eğitim', order: 1, ar: 'التَّعْليمُ' },
                ...
                { words: [
                    { tr: 'Öğretmen', order: 1, ar: 'المُعَلِّمُ' },
                    { tr: 'dersi açıkladı.', order: 2, ar: 'شَرَحَ الدَّرْسَ.' }
                ] },
                { words: [
                ...
                { words: [
                    ...
                    { tr: 'beşikten mezara kadar.', order: 2, ar: 'مِن المَهْدِ إِلى اللَّحْدِ.' }
                ] },
                { words: [
                    { tr: 'Bu araştırma', order: 1, ar: 'هٰذا البَحْثُ' },
                    { tr: 'yeni bilgi veriyor.', order: 2, ar: 'يُقَدِّمُ مَعْرِفَةً جَديدَةً.' }
                ] },
                { words: [
            ...
            dialog: [
                ...
                {
                    p1: [
                        { tr: "Öğretmen", order: 2, ar: "المُعَلِّمُ؟" },
                        { tr: "ne anlattı?", order: 1, ar: "ماذا شَرَحَ" }
                    ],
                    p2: [
                        { tr: "Yeni dersi", order: 2, ar: "الدَّرْسَ الجَديدَ." },
        ...
        },
        {
            ...
            words: [
                ...
                { tr: 'Devlet', ar: 'الدَّوْلَة' },
                { tr: 'Halife', ar: 'الخَليفَة' },
                { tr: 'Savaş', ar: 'الحَرْب' },
                { tr: 'Barış', ar: 'السَّلام' },
                { tr: 'Fetih', ar: 'الفَتْح' },
                { tr: 'Asır', ar: 'القَرْن' },
                { tr: 'Miras', ar: 'التُّراث' },
            ...
            sentence: [
                { words: [
                    ...
                    { tr: 'milletlerin hafızasıdır.', order: 2, ar: 'ذاكِرَةُ الشُّعوبِ.' }
                ] },
                { words: [
                    { tr: 'İslam medeniyeti', order: 1, ar: 'الحَضارَةُ الإِسْلامِيَّةُ' },
                    { tr: 'insanlığa katkı sundu.', order: 2, ar: 'أَسْهَمَتْ في الإِنْسانِيَّةِ.' }
                ] },
                { words: [
                ...
                { words: [
                    { tr: 'Tarihçi', order: 1, ar: 'المُؤَرِّخُ' },
                ...
                { words: [
                    ...
                    { tr: 'barışla.', order: 3, ar: 'بِالسَّلامِ.' }
                ] },
                { words: [
                    { tr: 'Bu belge', order: 1, ar: 'هٰذِهِ الوَثيقَةُ' },
                    { tr: 'çok eskidir.', order: 2, ar: 'قَديمَةٌ جِدًّا.' }
                ] },
                { words: [
                    { tr: 'Devlet', order: 1, ar: 'الدَّوْلَةُ' },
                    { tr: 'geniş bir bölgeye yayıldı.', order: 2, ar: 'اِتَّسَعَتْ في مِنْطَقَةٍ واسِعَةٍ.' }
                ] }
            ],
            dialog: [
                {
                ...
                {
                    p1: [
                        { tr: "Tarihçi", order: 2, ar: "المُؤَرِّخُ؟" },
                ...
                },
                {
                    p1: [
                        ...
                        { tr: "nasıl sona erdi?", order: 1, ar: "كَيْف انْتَهَتِ" }
                    ],
                    p2: [
                        { tr: "Barışla", order: 2, ar: "بِالسَّلامِ." },
                        { tr: "sona erdi.", order: 1, ar: "انْتَهَتْ" }
                    ]
                },
                {
                    p1: [
                        { tr: "Mirası", order: 2, ar: "التُّراثَ؟" },
                        { tr: "niçin koruruz?", order: 1, ar: "لِماذا نَحْفَظُ" }
                    ],
                    p2: [
                        { tr: "Çünkü o", order: 1, ar: "لِأَنَّهُ" },
                        { tr: "milletin hafızasıdır.", order: 2, ar: "ذاكِرَةُ الأُمَّةِ." }
                    ]
                }
            ]
        },
        {
            ...
            sentence: [
                { words: [
                    ...
                    { tr: 'hakikati arar.', order: 2, ar: 'تَبْحَثُ عَن الحَقيقَةِ.' }
                ] },
                { words: [
                ...
                { words: [
                    { tr: 'Şüphe', order: 1, ar: 'الشَّكُّ' },
                    { tr: 'yakîne giden yoldur.', order: 2, ar: 'طَريقٌ إِلى اليَقينِ.' }
                ] },
                { words: [
                    { tr: 'Filozof', order: 1, ar: 'الفَيْلَسوفُ' },
                    { tr: 'varlık üzerine düşünür.', order: 2, ar: 'يُفَكِّرُ في الوُجودِ.' }
                ] },
                { words: [
                    { tr: 'Bu görüşün', order: 2, ar: 'دَليلٌ' },
                    { tr: 'delili var mı?', order: 1, ar: 'هَلْ لِهٰذا الرَّأْيِ' }
                ] },
                { words: [
                ...
                { words: [
                    ...
                    { tr: 'doğru düşünmenin ölçüsüdür.', order: 2, ar: 'ميزانُ التَّفْكيرِ الصَّحيحِ.' }
                ] },
                { words: [
                    { tr: 'Hikmet', order: 1, ar: 'الحِكْمَةُ' },
                    { tr: 'müminin yitiğidir.', order: 2, ar: 'ضالَّةُ المُؤْمِنِ.' }
                ] }
            ],
            dialog: [
                {
                    ...
                    p2: [
                        { tr: "Hakikati", order: 2, ar: "عَن الحَقيقَةِ." },
                        { tr: "arar.", order: 1, ar: "تَبْحَثُ" }
                    ]
                },
                {
                    p1: [
                        { tr: "Bu görüşün", order: 1, ar: "هَلْ لِهٰذا الرَّأْيِ" },
                ...
                },
                {
                    p1: [
                        ...
                        { tr: "ne üzerine düşünür?", order: 1, ar: "في ماذا يُفَكِّرُ" }
                    ],
                    p2: [
                        { tr: "Varlık ve bilgi üzerine", order: 2, ar: "في الوُجودِ وَالمَعْرِفَةِ." },
                        { tr: "düşünür.", order: 1, ar: "يُفَكِّرُ" }
                    ]
                },
                {
                    p1: [
                        { tr: "Hangisi önce gelir,", order: 1, ar: "أَيُّهُما أَسْبَقُ،" },
        ...
        },
        {
            ...
            words: [
                { tr: 'Din', ar: 'الدّين' },
                { tr: 'İman', ar: 'الإيمان' },
                { tr: 'Namaz', ar: 'الصَّلاة' },
                { tr: 'Oruç', ar: 'الصَّوْم' },
                { tr: 'Zekât', ar: 'الزَّكاة' },
                { tr: 'Hac', ar: 'الحَجّ' },
                { tr: 'Kur\'an', ar: 'القُرْآن' },
                { tr: 'Sünnet', ar: 'السُّنَّة' },
                { tr: 'Cami', ar: 'المَسْجِد', /*L*/ lh: { mag: 'الجامِع' } },
                { tr: 'İbadet', ar: 'العِبادَة' },
                { tr: 'Takva', ar: 'التَّقْوى' },
                { tr: 'Dua', ar: 'الدُّعاء' }
            ],

            sentence: [
                { words: [
                    { tr: 'Namaz', order: 1, ar: 'الصَّلاةُ' },
                ...
                { words: [
                    ...
                    { tr: 'her cuma.', order: 3, ar: 'كُلَّ جُمُعَةٍ.' }
                ] },
                { words: [
                    { tr: 'Zekât', order: 1, ar: 'الزَّكاةُ' },
                    { tr: 'malı temizler.', order: 2, ar: 'تُطَهِّرُ المالَ.' }
                ] },
                { words: [
                    { tr: 'Dua', order: 1, ar: 'الدُّعاءُ' },
                    { tr: 'ibadetin özüdür.', order: 2, ar: 'مُخُّ العِبادَةِ.' }
                ] },
                { words: [
                    { tr: 'Hac', order: 1, ar: 'الحَجُّ' },
                    { tr: 'gücü yetene farzdır.', order: 2, ar: 'فَرْضٌ عَلى المُسْتَطيعِ.' }
                ] },
                { words: [
                    { tr: 'Takva', order: 1, ar: 'التَّقْوى' },
            ...
            dialog: [
                {
                    ...
                    p2: [
                        { tr: "Her cuma", order: 2, ar: "كُلَّ جُمُعَةٍ." },
        ...
        {
            id: 'bilim', grup: 'genel',
            ad: 'Bilim & Teknoloji', ar: 'العِلْم والتِّقْنِيَة',

            words: [
                { tr: 'Bilim', ar: 'العِلْم' },
                { tr: 'Teknoloji', ar: 'التِّكْنولوجْيا' },
                { tr: 'Bilgisayar', ar: 'الحاسوب', /*L*/ lh: { mis: 'الكُمْبيوتَر', sam: 'الكُمْبيوتَر', hic: 'الكُمْبيوتَر', kor: 'الكُمْبيوتَر', irk: 'الكُمْبيوتَر', mag: 'لُورْديناتور' } },
                { tr: 'İnternet', ar: 'الإِنْتَرْنِت', /*L*/ lh: { mis: 'النِّت', sam: 'النِّت', hic: 'النِّت', kor: 'النِّت', irk: 'النِّت', mag: 'لَانْتيرْنِت' } },
                { tr: 'Deney', ar: 'التَّجْرِبَة' },
                { tr: 'Laboratuvar', ar: 'المُخْتَبَر' },
                { tr: 'Keşif', ar: 'الاِكْتِشاف' },
                { tr: 'İcat', ar: 'الاِخْتِراع' },
                { tr: 'Enerji', ar: 'الطّاقَة' },
                { tr: 'Yapay zekâ', ar: 'الذَّكاءُ الاِصْطِناعِيّ' },
                { tr: 'Uygulama', ar: 'التَّطْبيق' },
            ...
            sentence: [
                { words: [
                    ...
                    { tr: 'hayatı değiştirdi.', order: 2, ar: 'غَيَّرَ الحَياةَ.' }
                ] },
                { words: [
                    { tr: 'Bilgisayar', order: 1, ar: 'الحاسوبُ' },
                    { tr: 'işi kolaylaştırıyor.', order: 2, ar: 'يُسَهِّلُ العَمَلَ.' }
                ] },
                { words: [
                ...
                { words: [
                    { tr: 'Yapay zekâ', order: 1, ar: 'الذَّكاءُ الاِصْطِناعِيُّ' },
                    { tr: 'hızla gelişiyor.', order: 2, ar: 'يَتَطَوَّرُ بِسُرْعَةٍ.' }
                ] },
                { words: [
                    { tr: 'Yenilenebilir enerji', order: 1, ar: 'الطّاقَةُ المُتَجَدِّدَةُ' },
                    { tr: 'çevreyi korur.', order: 2, ar: 'تَحْمي البيئَةَ.' }
                ] },
                { words: [
                    { tr: 'Bu icat', order: 1, ar: 'هٰذا الاِخْتِراعُ' },
                    { tr: 'insanlığa fayda sağladı.', order: 2, ar: 'نَفَعَ الإِنْسانِيَّةَ.' }
                ] },
                { words: [
                    { tr: 'Veriyi', order: 2, ar: 'البَياناتِ' },
                    { tr: 'dikkatle analiz ediyoruz.', order: 1, ar: 'نُحَلِّلُ' },
            ...
            dialog: [
                {
                    p1: [
                        ...
                        { tr: "nerede yapar?", order: 1, ar: "أَيْن يُجْري" }
                    ],
                    p2: [
                ...
                },
                {
                    p1: [
                        ...
                        { tr: "nasıl değiştirdi?", order: 1, ar: "كَيْف غَيَّرَ" }
                    ],
                    p2: [
                        { tr: "İşi kolaylaştırdı", order: 1, ar: "سَهَّلَ العَمَلَ" },
                        { tr: "ve dünyayı birleştirdi.", order: 2, ar: "وَرَبَطَ العالَمَ." }
                    ]
                },
                {
                    p1: [
                        { tr: "Yapay zekâyı", order: 2, ar: "الذَّكاءَ الاِصْطِناعِيَّ؟" },
                ...
                {
                    p1: [
                        { tr: "Yenilenebilir enerjiye", order: 2, ar: "الطّاقَةَ المُتَجَدِّدَةَ؟" },
        ...
        },
        {
            ...
            ad: 'Ekonomi & Ticaret', ar: 'الاقْتِصاد والتِّجارَة',

            words: [
                { tr: 'Ekonomi', ar: 'الاِقْتِصاد' },
                { tr: 'Ticaret', ar: 'التِّجارَة' },
                { tr: 'Pazar', ar: 'السّوق', /*L*/ lh: { mag: 'السّوق دْيال المْدينَة' } },
                { tr: 'Sermaye', ar: 'رَأْسُ المالِ' },
                { tr: 'Kâr', ar: 'الرِّبْح' },
                { tr: 'Zarar', ar: 'الخَسارَة' },
                { tr: 'Şirket', ar: 'الشَّرِكَة' },
                { tr: 'Banka', ar: 'البَنْك' },
                { tr: 'Yatırım', ar: 'الاِسْتِثْمار' },
                { tr: 'Bütçe', ar: 'الميزانِيَّة' },
                { tr: 'Enflasyon', ar: 'التَّضَخُّم' },
            ...
            sentence: [
                ...
                { words: [
                    { tr: 'Şirket', order: 1, ar: 'الشَّرِكَةُ' },
                    { tr: 'büyük kâr elde etti.', order: 2, ar: 'حَقَّقَتْ رِبْحًا كَبيرًا.' }
                ] },
                { words: [
                    { tr: 'Banka', order: 1, ar: 'البَنْكُ' },
                    { tr: 'tüccarlara kredi veriyor.', order: 2, ar: 'يُقْرِضُ التُّجّارَ.' }
                ] },
                { words: [
                ...
                { words: [
                    ...
                    { tr: 'enflasyon sebebiyle yükseldi.', order: 2, ar: 'اِرْتَفَعَتْ بِسَبَبِ التَّضَخُّمِ.' }
                ] },
                { words: [
                    { tr: 'Devlet', order: 1, ar: 'الدَّوْلَةُ' },
                    { tr: 'yıllık bütçeyi hazırladı.', order: 2, ar: 'أَعَدَّتِ الميزانِيَّةَ السَّنَوِيَّةَ.' }
                ] },
                { words: [
                    { tr: 'İhracat', order: 1, ar: 'التَّصْديرُ' },
                    { tr: 'ithalattan fazla.', order: 2, ar: 'أَكْثَرُ مِن الاِسْتيرادِ.' }
                ] }
            ],
            dialog: [
                {
                    p1: [
                        ...
                        { tr: "ekonominin durumu nasıl?", order: 1, ar: "كَيْف حالُ الاِقْتِصادِ" }
                    ],
                    p2: [
                        { tr: "İyi bir oranda", order: 2, ar: "بِنِسْبَةٍ جَيِّدَةٍ." },
                        { tr: "büyüdü.", order: 1, ar: "نَما" }
                    ]
                },
                {
                    p1: [
                        { tr: "Şirket", order: 2, ar: "الشَّرِكَةُ؟" },
                        { tr: "kâr etti mi?", order: 1, ar: "هَلْ رَبِحَتِ" }
                    ],
                    p2: [
                        { tr: "Evet,", order: 1, ar: "نَعَمْ،" },
                        { tr: "büyük bir kâr elde etti.", order: 2, ar: "حَقَّقَتْ رِبْحًا كَبيرًا." }
                    ]
                },
                {
                    p1: [
                    ...
                    p2: [
                        { tr: "Enflasyon sebebiyle.", order: 1, ar: "بِسَبَبِ التَّضَخُّمِ." }
                    ]
                },
                {
                    p1: [
                        { tr: "Paranı", order: 2, ar: "مالَكَ؟" },
                        { tr: "nereye yatırıyorsun?", order: 1, ar: "أَيْن تَسْتَثْمِرُ" }
                    ],
                    p2: [
                        { tr: "Ticarete ve sanayiye.", order: 1, ar: "في التِّجارَةِ وَالصِّناعَةِ." }
                    ]
                }
            ]
        },
        {
            ...
            words: [
                ...
                { tr: 'Dava', ar: 'القَضِيَّة' },
                { tr: 'Hak', ar: 'الحَقّ' },
                { tr: 'Görev', ar: 'الواجِب' },
                { tr: 'Ceza', ar: 'العُقوبَة' },
                { tr: 'Şahit', ar: 'الشّاهِد' },
                { tr: 'Delil (hukuk)', ar: 'الدَّليل' },
                { tr: 'Anayasa', ar: 'الدُّسْتور' }
            ],
            ...
            sentence: [
                ...
                { words: [
                    ...
                    { tr: 'davada hüküm verdi.', order: 2, ar: 'حَكَمَ في القَضِيَّةِ.' }
                ] },
                { words: [
                    { tr: 'Avukat', order: 1, ar: 'المُحامي' },
                    { tr: 'müvekkilini savundu.', order: 2, ar: 'دافَعَ عَنْ مُوَكِّلِهِ.' }
                ] },
                { words: [
                    { tr: 'Kanun', order: 1, ar: 'القانونُ' },
                    { tr: 'herkese eşit uygulanır.', order: 2, ar: 'يُطَبَّقُ عَلى الجَميعِ.' }
                ] },
                { words: [
                    { tr: 'Şahit', order: 1, ar: 'الشّاهِدُ' },
                    { tr: 'mahkemede doğruyu söyledi.', order: 2, ar: 'قالَ الصِّدْقَ في المَحْكَمَةِ.' }
                ] },
                { words: [
                    { tr: 'Her hakkın', order: 1, ar: 'لِكُلِّ حَقٍّ' },
                    { tr: 'bir görevi vardır.', order: 2, ar: 'واجِبٌ.' }
                ] },
                { words: [
                    { tr: 'Anayasa', order: 1, ar: 'الدُّسْتورُ' },
            ...
            dialog: [
                {
                    p1: [
                        { tr: "Davada", order: 2, ar: "في القَضِيَّةِ؟" },
                ...
                },
                {
                    ...
                    p2: [
                        { tr: "Evet,", order: 1, ar: "نَعَمْ،" },
                        { tr: "doğruyu da söyledi.", order: 2, ar: "وَقالَ الصِّدْقَ." }
                    ]
                },
                {
                    p1: [
                        { tr: "Anayasa", order: 2, ar: "الدُّسْتورُ؟" },
                ...
                },
                {
                    p1: [
                        ...
                        { tr: "kime uygulanır?", order: 1, ar: "عَلى مَنْ يُطَبَّقُ" }
                    ],
                    p2: [
                        { tr: "Herkese", order: 2, ar: "عَلى الجَميعِ." },
                        { tr: "uygulanır.", order: 1, ar: "يُطَبَّقُ" }
                    ]
                }
            ]
        },
        {
            ...
            ad: 'Siyaset & Medya', ar: 'السِّياسَة والإعْلام',

            words: [
                { tr: 'Siyaset', ar: 'السِّياسَة' },
                { tr: 'Hükümet', ar: 'الحُكومَة' },
                { tr: 'Başkan', ar: 'الرَّئيس' },
                ...
                { tr: 'Kanal', ar: 'القَناة' },
                { tr: 'Basın', ar: 'الصَّحافَة' },
                { tr: 'Kamuoyu', ar: 'الرَّأْيُ العامّ' },
                { tr: 'Anlaşma', ar: 'الاِتِّفاقِيَّة' }
            ],

            sentence: [
                { words: [
                    { tr: 'Hükümet', order: 1, ar: 'الحُكومَةُ' },
                    { tr: 'yeni bir karar aldı.', order: 2, ar: 'اِتَّخَذَتْ قَرارًا جَديدًا.' }
                ] },
                { words: [
                    { tr: 'Seçimler', order: 1, ar: 'الاِنْتِخاباتُ' },
                    { tr: 'gelecek ay yapılacak.', order: 2, ar: 'سَتُجْرى الشَّهْرَ القادِمَ.' }
                ] },
                { words: [
                ...
                { words: [
                    { tr: 'Basın', order: 1, ar: 'الصَّحافَةُ' },
                    { tr: 'kamuoyunu etkiler.', order: 2, ar: 'تُؤَثِّرُ في الرَّأْيِ العامِّ.' }
                ] },
                { words: [
                    { tr: 'İki devlet', order: 1, ar: 'الدَّوْلَتانِ' },
                    { tr: 'bir anlaşma imzaladı.', order: 2, ar: 'وَقَّعَتا اتِّفاقِيَّةً.' }
                ] },
                { words: [
                    { tr: 'Başkan', order: 1, ar: 'الرَّئيسُ' },
                    { tr: 'parlamentoda konuştu.', order: 2, ar: 'تَحَدَّثَ في البَرْلَمانِ.' }
                ] },
                { words: [
                ...
                { words: [
                    { tr: 'Siyaset', order: 1, ar: 'السِّياسَةُ' },
                    { tr: 'mümkünün sanatıdır.', order: 2, ar: 'فَنُّ المُمْكِنِ.' }
                ] }
            ],
            dialog: [
                {
                ...
                },
                {
                    p1: [
                        ...
                        { tr: "nerede okudun?", order: 1, ar: "أَيْن قَرَأْتَ" }
                    ],
                    p2: [
                ...
                },
                {
                    p1: [
                        ...
                        { tr: "ne karar aldı?", order: 1, ar: "ماذا اتَّخَذَتِ" }
                    ],
                    p2: [
                        { tr: "Yeni bir karar", order: 2, ar: "قَرارًا جَديدًا." },
                        { tr: "aldı.", order: 1, ar: "اتَّخَذَتْ" }
                    ]
                },
                {
                    p1: [
                        { tr: "Anlaşma", order: 2, ar: "الاِتِّفاقِيَّةُ؟" },
                        { tr: "imzalandı mı?", order: 1, ar: "هَلْ وُقِّعَتِ" }
                    ],
                    p2: [
                        { tr: "Evet,", order: 1, ar: "نَعَمْ،" },
                        { tr: "iki devlet imzaladı.", order: 2, ar: "وَقَّعَتْها الدَّوْلَتانِ." }
                    ]
                }
            ]
        },
        {
            ...
            words: [
                ...
                { tr: 'Şiir', ar: 'الشِّعْر' },
                { tr: 'Şair', ar: 'الشّاعِر' },
                { tr: 'Roman', ar: 'الرِّوايَة' },
                { tr: 'Hikâye', ar: 'القِصَّة' },
                { tr: 'Yazar', ar: 'الكاتِب' },
                { tr: 'Nesir', ar: 'النَّثْر' },
                { tr: 'Tiyatro', ar: 'المَسْرَح' },
                { tr: 'Sanat', ar: 'الفَنّ' },
                { tr: 'Resim', ar: 'اللَّوْحَة' },
            ...
            sentence: [
                { words: [
                    { tr: 'Arap edebiyatı', order: 1, ar: 'الأَدَبُ العَرَبِيُّ' },
                    { tr: 'köklü ve zengindir.', order: 2, ar: 'عَريقٌ وَغَنِيٌّ.' }
                ] },
                { words: [
                ...
                { words: [
                    { tr: 'Bu roman', order: 1, ar: 'هٰذِهِ الرِّوايَةُ' },
                    { tr: 'toplumu anlatıyor.', order: 2, ar: 'تَصِفُ المُجْتَمَعَ.' }
                ] },
                { words: [
                    { tr: 'Hikâyeyi', order: 2, ar: 'القِصَّةَ' },
                    { tr: 'bir gecede okudum.', order: 1, ar: 'قَرَأْتُ' },
                    { tr: 'bir gecede.', order: 3, ar: 'في لَيْلَةٍ واحِدَةٍ.' }
                ] },
                { words: [
                    { tr: 'Hat sanatı', order: 1, ar: 'الخَطُّ العَرَبِيُّ' },
                    { tr: 'İslam sanatlarındandır.', order: 2, ar: 'مِن الفُنونِ الإِسْلامِيَّةِ.' }
                ] },
                { words: [
                    { tr: 'Tiyatro', order: 1, ar: 'المَسْرَحُ' },
                    { tr: 'yeni bir oyun sundu.', order: 2, ar: 'قَدَّمَ مَسْرَحِيَّةً جَديدَةً.' }
                ] },
                { words: [
            ...
            dialog: [
                {
                    ...
                    p2: [
                        { tr: "Arapça bir roman", order: 2, ar: "رِوايَةً عَرَبِيَّةً." },
                ...
                {
                    p1: [
                        { tr: "Arap hattını", order: 2, ar: "الخَطَّ العَرَبِيَّ؟" },
                        { tr: "sever misin?", order: 1, ar: "هَلْ تُحِبُّ" }
                    ],
                    p2: [
                        { tr: "Evet,", order: 1, ar: "نَعَمْ،" },
                ...
                },
                {
                    p1: [
                        ...
                        { tr: "ne sundu?", order: 1, ar: "ماذا قَدَّمَ" }
                    ],
                    p2: [
                        { tr: "Yeni bir oyun", order: 2, ar: "مَسْرَحِيَّةً جَديدَةً." },
                        { tr: "sundu.", order: 1, ar: "قَدَّمَ" }
                    ]
                }
            ]
        },
        {
            ...
            words: [
                { tr: 'Çevre', ar: 'البيئَة' },
                { tr: 'Doğa', ar: 'الطَّبيعَة' },
                { tr: 'Ağaç', ar: 'الشَّجَرَة', /*L*/ lh: { mag: 'الشّجْرَة' } },
                { tr: 'Orman', ar: 'الغابَة' },
                { tr: 'Kirlilik', ar: 'التَّلَوُّث' },
                { tr: 'Hava', ar: 'الهَواء' },
                { tr: 'İklim', ar: 'المُناخ' },
                { tr: 'Geri dönüşüm', ar: 'إِعادَةُ التَّدْويرِ' },
                { tr: 'Çöp', ar: 'النُّفايات', /*L*/ lh: { mis: 'الزِّبالَة', sam: 'الزِّبالِة', hic: 'الزِّبالَة', kor: 'الزِّبالَة', irk: 'الزِّبالَة', mag: 'الزّبَل' } },
                { tr: 'Su kaynakları', ar: 'مَواردُ المِياهِ' },
                { tr: 'Çöl', ar: 'الصَّحْراء' },
            ...
            sentence: [
                ...
                { words: [
                    { tr: 'Kirlilik', order: 1, ar: 'التَّلَوُّثُ' },
                    { tr: 'sağlığa zarar veriyor.', order: 2, ar: 'يَضُرُّ بِالصِّحَّةِ.' }
                ] },
                { words: [
                    { tr: 'İklim', order: 1, ar: 'المُناخُ' },
                    { tr: 'son yıllarda değişti.', order: 2, ar: 'تَغَيَّرَ في السَّنَواتِ الأَخيرَةِ.' }
                ] },
                { words: [
                    { tr: 'Çöpü', order: 2, ar: 'النُّفاياتِ' },
                ...
                { words: [
                    { tr: 'Her yıl', order: 2, ar: 'كُلَّ عامٍ.' },
            ...
            dialog: [
                {
                    p1: [
                        { tr: "Çevreyi", order: 2, ar: "البيئَةَ؟" },
                        { tr: "nasıl koruruz?", order: 1, ar: "كَيْف نَحْمي" }
                    ],
                    p2: [
                        { tr: "Ağaç dikeriz", order: 1, ar: "نَزْرَعُ الأَشْجارَ" },
                        { tr: "ve çöpü azaltırız.", order: 2, ar: "وَنُقَلِّلُ النُّفاياتِ." }
                    ]
                },
                {
                    p1: [
                        { tr: "Kirliliğin", order: 1, ar: "ما ضَرَرُ" },
                        { tr: "zararı nedir?", order: 2, ar: "التَّلَوُّثِ؟" }
                    ],
                    p2: [
                        { tr: "Sağlığa ve havaya", order: 2, ar: "بِالصِّحَّةِ وَالهَواءِ." },
                        { tr: "zarar verir.", order: 1, ar: "يَضُرُّ" }
                    ]
                },
                {
                    p1: [
                        { tr: "İklim", order: 2, ar: "المُناخُ؟" },
                        { tr: "değişti mi?", order: 1, ar: "هَلْ تَغَيَّرَ" }
                    ],
                    p2: [
                        { tr: "Evet,", order: 1, ar: "نَعَمْ،" },
                        { tr: "çok değişti.", order: 2, ar: "تَغَيَّرَ كَثيرًا." }
                    ]
                },
                {
                    p1: [
                        { tr: "Geri dönüşümü", order: 2, ar: "التَّدْويرَ؟" },
        ...
        },
        {
            ...
            ad: 'Seyahat & Turizm', ar: 'السَّفَر والسِّياحَة',

            words: [
                { tr: 'Seyahat', ar: 'السَّفَر' },
                { tr: 'Uçak', ar: 'الطّائِرَة',
                  lh: { mis: 'الطَّيّارَة', sam: 'الطَّيّارَة', hic: 'الطَّيّارَة', kor: 'الطَّيّارَة', irk: 'الطَّيّارَة', mag: 'الطّيّارَة' } },
                ...
                { tr: 'Pasaport', ar: 'جَوازُ السَّفَرِ' },
                { tr: 'Bilet', ar: 'التَّذْكِرَة',
                  lh: { mis: 'التَّذْكَرَة', sam: 'التَّذْكَرَة', hic: 'التَّذْكَرَة', kor: 'التَّذْكَرَة', irk: 'التَّذْكَرَة', mag: 'الوَرْقَة' } },
                { tr: 'Bavul', ar: 'الحَقيبَة',
                  lh: { mis: 'الشَّنْطَة', sam: 'الشَّنْتا', hic: 'الشَّنْطَة', kor: 'الجُنْطَة', irk: 'الجُنْطَة', mag: 'الساك' } },
                { tr: 'Yolculuk / gezi', ar: 'الرِّحْلَة', /*L*/ lh: { mag: 'الخَرْجَة' } },
            ...
            sentence: [
                { words: [
                    { tr: 'Yaz tatilinde', order: 2, ar: 'في العُطْلَةِ الصَّيْفِيَّةِ.',
                  lh: { mis: 'في الأَجازَة الصَّيْفي.', sam: 'بِالعُطْلِة الصَّيْفِيِّة.', hic: 'في الإِجازَة الصَّيْفِيَّة.', kor: 'في الإِجازَة الصَّيْفِيَّة.', irk: 'بِالعُطْلَة الصَّيْفِيَّة.', mag: 'فْالعُطْلَة دْيال الصّيف.' } },
                ...
                { words: [
                  ...
                  lh: { mis: 'بِتْقوم الصُّبْح.', sam: 'بِتْقَلِّع الصُّبِح.', hic: 'تْقَلِّع الصُّبْح.', kor: 'تْقَلِّع الصُّبْح.', irk: 'تْقَلِّع الصُّبُح.', mag: 'كَتْقْلَع فْالصْباح.' } }
                ] },
                { words: [
                ...
                { words: [
                  ...
                  lh: { mis: 'في الشَّنْطَة.', sam: 'بِالشَّنْتا.', hic: 'في الشَّنْطَة.', kor: 'في الجُنْطَة.', irk: 'بِالجُنْطَة.', mag: 'فْالساك.' } }
                ] },
                { words: [
                ...
                { words: [
                  ...
                  lh: { mis: 'المَدينَة دي', sam: 'هَالمَدينِة', hic: 'هٰذِهِ المَدينَة', kor: 'هٰذِهِ المَدينَة', irk: 'هَاي المَدينَة', mag: 'هاد المْدينَة' } },
                    { tr: 'turistleri çekiyor.', order: 2, ar: 'تَجْذِبُ السُّيّاحَ.',
                  lh: { mis: 'بِتِجْذِب السُّيّاح.', sam: 'بِتِجْذِب السُّيّاح.', hic: 'تِجْذِب السُّيّاح.', kor: 'تِجْذِب السُّيّاح.', irk: 'تِجْذِب السُّيّاح.', mag: 'كَتْجْذَب السّْياح.' } }
                ] },
                { words: [
                ...
                { words: [
                    { tr: 'Yolculuk', order: 1, ar: 'الرِّحْلَةُ',
                  lh: { mis: 'الرِّحْلَة', sam: 'الرِّحْلِة', hic: 'الرِّحْلَة', kor: 'الرِّحْلَة', irk: 'الرِّحْلَة', mag: 'الرِّحْلَة' } },
                    { tr: 'çok güzeldi.', order: 2, ar: 'كانَتْ جَميلَةً جِدًّا.',
                  lh: { mis: 'كانِت حِلْوَة أَوي.', sam: 'كانِت كْتير حِلْوِة.', hic: 'كانَت حِلْوَة مَرَّة.', kor: 'كانَت حِلْوَة وايِد.', irk: 'كانَت حِلْوَة كُلِّش.', mag: 'كانَت زْوينَة بِزّاف.' } }
                ] }
            ],
            dialog: [
                {
                    p1: [
                        { tr: 'Bu yaz', order: 1, ar: 'إِلى أَيْن تُسافِرُ',
                  lh: { mis: 'هَتْسافِر فين', sam: 'لَوين رَح تْسافِر', hic: 'وين بْتْسافِر', kor: 'وين بْتْسافِر', irk: 'لَوين راح تْسافِر', mag: 'لْفين غادي تْسافَر' } },
                        { tr: 'nereye seyahat edeceksin?', order: 2, ar: 'هٰذا الصَّيْفَ؟',
                  lh: { mis: 'الصِّيْف دَه؟', sam: 'هَالصّيْف؟', hic: 'هٰذا الصَّيْف؟', kor: 'هٰذا الصَّيْف؟', irk: 'هٰذا الصّيْف؟', mag: 'هاد الصّيف؟' } }
                    ],
                    p2: [
                ...
                {
                    p1: [
                        { tr: 'Pasaportun', order: 1, ar: 'أَيْن',
                  ...
                  lh: { mis: 'في الشَّنْطَة،', sam: 'بِالشَّنْتا،', hic: 'في الشَّنْطَة،', kor: 'في الجُنْطَة،', irk: 'بِالجُنْطَة،', mag: 'فْالساك،' } },
                        { tr: 'biletle birlikte.', order: 2, ar: 'مَعَ التَّذْكِرَةِ.',
                  lh: { mis: 'مَعَ التَّذْكَرَة.', sam: 'مَعَ التَّذْكَرَة.', hic: 'مَعَ التَّذْكَرَة.', kor: 'مَعَ التَّذْكَرَة.', irk: 'وِيَّ التَّذْكَرَة.', mag: 'مْعَ الوَرْقَة.' } }
                    ]
                },
                {
                    p1: [
                        { tr: 'Uçak', order: 1, ar: 'مَتى تُقْلِعُ',
                  lh: { mis: 'إِمْتى هَتْقوم', sam: 'إيمْتى بِتْقَلِّع', hic: 'مَتى تْقَلِّع', kor: 'مَتى تْقَلِّع', irk: 'شْوَكِت تْقَلِّع', mag: 'إيمْتى كَتْقْلَع' } },
                        { tr: 'ne zaman kalkıyor?', order: 2, ar: 'الطّائِرَةُ؟',
                  lh: { mis: 'الطَّيّارَة؟', sam: 'الطَّيّارَة؟', hic: 'الطَّيّارَة؟', kor: 'الطَّيّارَة؟', irk: 'الطَّيّارَة؟', mag: 'الطّيّارَة؟' } }
                    ],
                    p2: [
                        { tr: 'Sabah', order: 1, ar: 'صَباحًا،',
                  lh: { mis: 'الصُّبْح،', sam: 'الصُّبِح،', hic: 'الصُّبْح،', kor: 'الصُّبْح،', irk: 'الصُّبُح،', mag: 'فْالصْباح،' } },
        ...
        {
            id: 'spor', grup: 'genel',
            ad: 'Spor', ar: 'الرِّياضَة',

            words: [
                { tr: 'Spor', ar: 'الرِّياضَة' },
                ...
                { tr: 'Stadyum', ar: 'المَلْعَب', /*L*/ lh: { mag: 'التيران' } },
                { tr: 'Antrenman', ar: 'التَّدْريب' },
                { tr: 'Kazanmak', ar: 'الفَوْز' },
                { tr: 'Kaybetmek', ar: 'الخَسارَة' },
                { tr: 'Yüzme', ar: 'السِّباحَة', /*L*/ lh: { mis: 'العوم', mag: 'العوم' } },
                { tr: 'Koşu', ar: 'الجَرْي' },
            ...
            sentence: [
                { words: [
                    { tr: 'Spor', order: 1, ar: 'الرِّياضَةُ',
                  lh: { mis: 'الرِّياضَة', sam: 'الرِّياضَة', hic: 'الرِّياضَة', kor: 'الرِّياضَة', irk: 'الرِّياضَة', mag: 'الرِّياضَة' } },
                ...
                { words: [
                    { tr: 'Her sabah', order: 2, ar: 'كُلَّ صَباحٍ.',
                  lh: { mis: 'كُلّ يوم الصُّبْح.', sam: 'كُلّ يوم الصُّبِح.', hic: 'كُلّ صَباح.', kor: 'كُلّ صُبْح.', irk: 'كُلّ يوم الصُّبُح.', mag: 'كُلّ صْباح.' } },
                ...
                { words: [
                    { tr: 'Yüzmeyi', order: 2, ar: 'السِّباحَةَ',
                  lh: { mis: 'العوم', sam: 'السِّباحَة', hic: 'السِّباحَة', kor: 'السِّباحَة', irk: 'السِّباحَة', mag: 'العومَة' } },
                    { tr: 'çok seviyorum.', order: 1, ar: 'أُحِبُّ',
                  lh: { mis: 'بَحِبّ', sam: 'بْحِبّ', hic: 'أُحِبّ', kor: 'أُحِبّ', irk: 'أَحِبّ', mag: 'كَنْبْغي' } },
                    { tr: 'çok.', order: 3, ar: 'كَثيرًا.',
                  lh: { mis: 'أَوي.', sam: 'كْتير.', hic: 'مَرَّة.', kor: 'وايِد.', irk: 'كُلِّش.', mag: 'بِزّاف.' } }
                ] },
                { words: [
                    { tr: 'Antrenman', order: 1, ar: 'التَّدْريبُ',
                  lh: { mis: 'التَّدْريب', sam: 'التَّدْريب', hic: 'التَّدْريب', kor: 'التَّدْريب', irk: 'التَّدْريب', mag: 'التَّدْريب' } },
                    { tr: 'her gün sürüyor.', order: 2, ar: 'مُسْتَمِرٌّ كُلَّ يَوْمٍ.',
            ...
            dialog: [
                {
                  ...
                  lh: { mis: 'كورَة؟', sam: 'طابِة؟', hic: 'كورَة؟', kor: 'كورَة؟', irk: 'طوبَة؟', mag: 'الكورَة؟' } }
                    ...
                    p2: [
                        { tr: 'Evet,', order: 1, ar: 'نَعَمْ،',
                  lh: { mis: 'أَيْوَه،', sam: 'أَيْ،', hic: 'أَيْوَه،', kor: 'إِي،', irk: 'إي،', mag: 'إيه،' } },
                        { tr: 'her cuma oynarım.', order: 2, ar: 'أَلْعَبُ كُلَّ جُمُعَةٍ.',
                ...
                },
                {
                  ...
                  lh: { mis: 'بَجْري', sam: 'بِرْكُض', hic: 'أَجْري', kor: 'أَجْري', irk: 'أَركُض', mag: 'كَنْجْري' } },
                        { tr: 'koşuyorum.', order: 2, ar: 'كُلَّ صَباحٍ.',
                  lh: { mis: 'كُلّ يوم الصُّبْح.', sam: 'كُلّ يوم الصُّبِح.', hic: 'كُلّ صَباح.', kor: 'كُلّ صُبْح.', irk: 'كُلّ يوم الصُّبُح.', mag: 'كُلّ صْباح.' } }
                    ],
                    p2: [
                        { tr: 'Spor', order: 1, ar: 'الرِّياضَةُ',
                ...
                },
                {
                  ...
                  lh: { mis: 'إِمْتى هَيِبْدَأ', sam: 'إيمْتى بْيِبْدا', hic: 'مَتى يِبْدَأ', kor: 'مَتى يِبْدَأ', irk: 'شْوَكِت يِبْدي', mag: 'إيمْتى غادي يْبْدا' } },
                        { tr: 'ne zaman başlıyor?', order: 2, ar: 'التَّدْريبُ؟',
                  lh: { mis: 'التَّدْريب؟', sam: 'التَّدْريب؟', hic: 'التَّدْريب؟', kor: 'التَّدْريب؟', irk: 'التَّدْريب؟', mag: 'التَّدْريب؟' } }
                    ],
                    p2: [
        ...
        {
            id: 'yemek', grup: 'genel',
            ad: 'Yemek & Mutfak', ar: 'الطَّعام والمَطْبَخ',

            words: [
                { tr: 'Yemek', ar: 'الطَّعام',
                ...
                { tr: 'Su', ar: 'الماء',
                  lh: { mis: 'المَيَّة', sam: 'المَيّ', hic: 'المَيَّة', kor: 'الماي', irk: 'المايّ', mag: 'الما' } },
                { tr: 'Et', ar: 'اللَّحْم' },
                { tr: 'Pirinç', ar: 'الأَرُزّ',
                  lh: { mis: 'الرُّزّ', sam: 'الرِّزّ', hic: 'الرُّزّ', kor: 'العيش', irk: 'التِّمَّن', mag: 'الروز' } },
                { tr: 'Sebze', ar: 'الخُضار', /*L*/ lh: { mag: 'الخُضْرَة' } },
                { tr: 'Meyve', ar: 'الفاكِهَة',
                  lh: { mis: 'الفاكْهَة', sam: 'الفَواكِه', hic: 'الفَواكِه', kor: 'الفَواكِه', irk: 'الفاكْهَة', mag: 'الفاكْيَة' } },
                { tr: 'Çay', ar: 'الشّاي', /*L*/ lh: { mag: 'أَتاي' } },
                ...
                { tr: 'Lezzetli', ar: 'لَذيذٌ',
                  lh: { mis: 'حِلْو أَوي', sam: 'طَيِّب', hic: 'لَذيذ', kor: 'زين', irk: 'لَذيذ', mag: 'بْنين' } },
                { tr: 'Acıktım', ar: 'أَنا جائِعٌ',
                  lh: { mis: 'أَنا جَعان', sam: 'أَنا جوعان', hic: 'أَنا جَوْعان', kor: 'أَنا يوعان', irk: 'آني جوعان', mag: 'أَنا فيَّ الجوع' } }
            ],
            ...
            sentence: [
                { words: [
                  ...
                  lh: { mis: 'بِتِطْبُخ أَكْل حِلْو.', sam: 'بِتِطْبُخ أَكِل طَيِّب.', hic: 'تِطْبُخ أَكْل لَذيذ.', kor: 'تِطْبُخ أَكِل زين.', irk: 'تِطْبُخ أَكِل لَذيذ.', mag: 'كَتْطَيَّب ماكْلَة بْنينَة.' } }
                ] },
                { words: [
                ...
                { words: [
                  ...
                  lh: { mis: 'كوبّايِة مَيَّة.', sam: 'كاسِة مَيّ.', hic: 'كوب مَيَّة.', kor: 'كوب ماي.', irk: 'گلاص مايّ.', mag: 'كاس دْيال الما.' } },
                    { tr: 'su içtim.', order: 1, ar: 'شَرِبْتُ',
                  lh: { mis: 'شِرِبْت', sam: 'شْرِبْت', hic: 'شِرِبْت', kor: 'شِرَبْت', irk: 'شِرَبِت', mag: 'شْرَبْت' } }
                ] },
                { words: [
                    { tr: 'Bu yemek', order: 1, ar: 'هٰذا الطَّعامُ',
                  lh: { mis: 'الأَكْل دَه', sam: 'هَالأَكِل', hic: 'هٰذا الأَكْل', kor: 'هٰذا الأَكِل', irk: 'هٰذا الأَكِل', mag: 'هاد الماكْلَة' } },
                    { tr: 'çok lezzetli.', order: 2, ar: 'لَذيذٌ جِدًّا.',
                  lh: { mis: 'حِلْو أَوي.', sam: 'كْتير طَيِّب.', hic: 'لَذيذ مَرَّة.', kor: 'زين وايِد.', irk: 'لَذيذ كُلِّش.', mag: 'بْنينَة بِزّاف.' } }
                ] },
                { words: [
                  ...
                  lh: { mis: 'مَعَ عيلْتي.', sam: 'مَعَ أَهْلي.', hic: 'مَعَ أَهْلي.', kor: 'مَعَ أَهْلي.', irk: 'وِيَّ أَهْلي.', mag: 'مْعَ العائِلَة دْيالي.' } }
                ] },
                { words: [
                    { tr: 'Meyve', order: 1, ar: 'الفاكِهَةُ',
                  lh: { mis: 'الفاكْهَة', sam: 'الفَواكِه', hic: 'الفَواكِه', kor: 'الفَواكِه', irk: 'الفاكْهَة', mag: 'الفاكْيَة' } },
                    { tr: 'sağlık için faydalıdır.', order: 2, ar: 'مُفيدَةٌ لِلصِّحَّةِ.',
                  lh: { mis: 'مُفيدَة لِلصِّحَّة.', sam: 'مْفيدِة لِلصِّحَّة.', hic: 'مُفيدَة لِلصِّحَّة.', kor: 'مُفيدَة لِلصِّحَّة.', irk: 'مُفيدَة لِلصِّحَّة.', mag: 'مْفيدَة لِلصِّحَّة.' } }
                ] },
                { words: [
                ...
                { words: [
                  ...
                  lh: { mis: 'لينا', sam: 'إِلْنا', hic: 'لَنا', kor: 'لَنا', irk: 'إِلْنا', mag: 'لينا' } },
                    { tr: 'bir fincan kahve hazırla.', order: 1, ar: 'أَعِدَّ',
            ...
            dialog: [
                ...
                },
                {
                  ...
                  lh: { mis: 'خُد كَمان شْوَيَّة.', sam: 'خود كَمان شْوَيّ.', hic: 'خُذ كَمان شْوَيّ.', kor: 'خُذ بَعَد شْوَيّ.', irk: 'خُذ هَمّ شْوَيَّة.', mag: 'دّي شْوِيَّة أُخْرى.' } }
                    ]
                },
                {
                    p1: [
                        { tr: 'Ne içersin,', order: 1, ar: 'ماذا تَشْرَبُ،',
                  lh: { mis: 'هَتِشْرَب إيه،', sam: 'شو بِدَّك تِشْرَب،', hic: 'إيش تِشْرَب،', kor: 'شِنو تِشْرَب،', irk: 'شْتِشْرَب،', mag: 'شْنو غادي تْشْرَب،' } },
