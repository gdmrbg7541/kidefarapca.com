...
window.KIDEF_SINAV = {
 ...
 maddeler: [
  ...
  { t:"izafet", ar:"قَلْعَة الفَتَاة", tr:"Kız Kalesi", oge:[["قَلْعَة","Muzâf"],["الفَتَاة","Muzâfun ileyh"]] },
  ...
  { t:"isimcum", ar:"الطَّقْسُ حارٌّ فِي الصَّيْفِ.", tr:"Yazın hava sıcaktır.", oge:[["الطَّقْسُ","Mübteda"],["حارٌّ","Haber"]] },
  { t:"isimcum", ar:"الجَوُّ جَميلٌ فِي الرَّبيعِ.", tr:"İlkbaharda hava güzeldir.", oge:[["الجَوُّ","Mübteda"],["جَميلٌ","Haber"]] },
  ...
  { t:"fiilcum", ar:"أُنَظِّفُ غُرْفَتي.", tr:"Odamı temizlerim.", oge:[["أُنَظِّفُ","Fiil"],["غُرْفَتي","Mef’ûl"]] },
