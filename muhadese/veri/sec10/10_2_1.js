/* 10. sınıf SEÇMELİ ARAPÇA — 2. Ünite (قِيَمي) 1. Ders: أُحِبُّ ديني
   Kaynak: Ortaöğretim Seçmeli Arapça ders kitabı, basılı s.50-61.
   Dersin konusu: İslam'ın şartları, beş vakit namaz, sıra sayıları (الأَوَّل-العاشِر),
...
window.data = {
    sentence: [
        ...
        {
            words: [
                { tr: "Oruç", order: 1, ar: "الصَّوْمُ" },
                { tr: "her Müslümana", order: 3, ar: "عَلى كُلِّ مُسْلِم." },
        ...
        /* Müslümanlar her yıl zekât verir. (s.52) */
        {
            words: [
                ...
                { tr: "her yıl", order: 4, ar: "كُلَّ سَنة." },
                { tr: "zekât", order: 3, ar: "الزَّكاةَ" },
        ...
        /* Sabah namazı güneşin doğuşundan öncedir. (s.52) */
        {
            words: [
                ...
                { tr: "güneşin doğuşundan", order: 3, ar: "شُروقِ الشَّمْس." },
        ...
        /* Akşam namazı güneşin batışından sonradır. (s.52) */
        {
            words: [
                ...
                { tr: "güneşin batışından", order: 3, ar: "غُروبِ الشَّمْس." },
        ...
        /* İslam'daki ilk emir okumaktır. (s.52) */
        {
            words: [
                ...
                { tr: "ilk emir", order: 1, ar: "الأَمْرُ الأَوَّلُ" },
        ...
        {
            words: [
                { tr: "Öğle namazını", order: 2, ar: "صَلاةَ الظُّهْرِ" },
        ...
        /* Müslümanlar günde beş vakit namaz kılar. (s.61) */
        {
            words: [
                { tr: "Müslümanlar", order: 2, ar: "المُسْلِمونَ" },
                { tr: "günde", order: 4, ar: "يَوْمِيًّا." },
        ...
        /* Büşra ikinci katta ve dördüncü dairede oturuyor. (s.55) */
        {
            words: [
                ...
                { tr: "ve dördüncü dairede", order: 4, ar: "وَفي الشُّقّةِ الرّابِعة." },
        ...
        /* Büşra dokuzuncu sınıfta okuyor. (s.55) */
        {
            words: [
                { tr: "Büşra", order: 2, ar: "بُشْرى" },
                { tr: "dokuzuncu sınıfta", order: 3, ar: "في الصَّفِّ التّاسِع." },
        ...
        /* Ramazan günlerinde sahura kalkıyorum. (s.58) */
        {
            words: [
                ...
                { tr: "sahura", order: 2, ar: "لِلسَّحورِ" },
        ...
        {
            words: [
                { tr: "Teravih namazı için", order: 4, ar: "لِصَلاةِ التَّراويح." },
    ...
    /* Kitaptaki iki diyalog: أَرْكان الإِسْلام ve الصَّلاة (s.50) */
    dialog: [
        {
            p1: [
        ...
        },
        {
            ...
            p2: [
                { tr: "Kelime-i şehadet,", order: 1, ar: "الشَّهادَتانِ،" },
                { tr: "namaz,", order: 2, ar: "وَالصَّلاةُ،" },
                { tr: "hac,", order: 3, ar: "وَالحَجُّ،" },
                { tr: "zekât", order: 4, ar: "وَالزَّكاةُ،" },
                { tr: "ve oruç.", order: 5, ar: "وَالصَّوْمُ." }
            ]
        },
        {
            p1: [
            ...
            p2: [
                { tr: "Öğle namazını", order: 2, ar: "صَلاةَ الظُّهْر." },
                { tr: "kılıyorum.", order: 1, ar: "أُصَلّي" }
            ]
        },
        {
...
window.data.words = [
    ...
    { tr: "Kelime-i şehadet", ar: "الشَّهادَتانِ" }, { tr: "Namaz", ar: "الصَّلاة" },
    { tr: "Zekât", ar: "الزَّكاة" }, { tr: "Oruç", ar: "الصَّوْم" },
    ...
    { tr: "Güneşin doğuşu", ar: "شُروق الشَّمْس" }, { tr: "Güneşin batışı", ar: "غُروب الشَّمْس" },
    { tr: "Sabah namazı", ar: "صَلاة الفَجْر" }, { tr: "Öğle namazı", ar: "صَلاة الظُّهْر" },
    { tr: "İkindi namazı", ar: "صَلاة العَصْر" }, { tr: "Akşam namazı", ar: "صَلاة المَغْرِب" },
    { tr: "Yatsı namazı", ar: "صَلاة العِشاء" }, { tr: "Teravih", ar: "التَّراويح" },
    { tr: "Sahur", ar: "سَحور" }, { tr: "İftar", ar: "الإِفْطار" },
    { tr: "Ramazan", ar: "رَمَضان" }, { tr: "Hicrî takvim", ar: "التَّقْويم الهِجْرِيّ" },
    { tr: "Kur'an-ı Kerim", ar: "القُرْآن الكَريم" }, { tr: "Melekler", ar: "المَلائِكة" },
    { tr: "Kitaplar", ar: "الكُتُب" }, { tr: "Peygamberler", ar: "الرُّسُل" },
    { tr: "Ahiret günü", ar: "اليَوْم الآخِر" }, { tr: "Kader", ar: "القَدَر" },
    { tr: "Yeniden diriliş", ar: "البَعْث" }, { tr: "Birinci", ar: "الأَوَّل" },
    ...
    { tr: "Apartman dairesi", ar: "الشُّقّة" }, { tr: "Önce, birinci olarak", ar: "أَوَّلًا" },
