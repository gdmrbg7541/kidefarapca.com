    ...
    sentence: [
        /* Bunlar babam ve amcam, onlar iki öğretmendir. (s.37) */
        {
            words: [
                ...
                { tr: "iki öğretmendir.", order: 4, ar: "مُدَرِّسانِ." }
            ]
        },
        ...
        /* Bunlar annem ve teyzem, onlar iki öğretmendir. (s.37) */
        {
            words: [
                ...
                { tr: "onlar", order: 3, ar: "هُما" },
                { tr: "iki öğretmendir.", order: 4, ar: "مُدَرِّسَتانِ." }
            ]
        },
        ...
        /* Pazartesi günü sıcaklık altı derecedir. (s.40) */
        {
            words: [
                ...
                { tr: "altı derecedir.", order: 2, ar: "سِتُّ دَرَجاتٍ" }
            ]
        },
        ...
        /* Ben balığı tercih ederim ama tavuğu tercih etmem. (s.44) */
        {
            words: [
                ...
                { tr: "tavuğu", order: 6, ar: "الدَّجاج." },
                { tr: "tercih etmem.", order: 5, ar: "لا أُفَضِّلُ" }
            ]
        },
        ...
        /* O çorba istiyor ama salata istemiyor. (s.44) */
        {
            words: [
                ...
                { tr: "ama", order: 4, ar: "لكِنْ" },
                { tr: "salata", order: 6, ar: "السَّلَطة." },
    ...
    dialog: [
        ...
        },
        {
            p1: [
                ...
                { tr: "pirinç", order: 3, ar: "مِن الأُرْزِ،" },
                { tr: "ve bir kutu", order: 4, ar: "وَعُلْبةً" },
                { tr: "çay", order: 5, ar: "مِن الشّاي." },
        ...
        },
        {
            ...
            p2: [
                { tr: "Ben", order: 1, ar: "أَنا" },
                { tr: "ayran", order: 3, ar: "اللَّبَن." },
                { tr: "istiyorum.", order: 2, ar: "أُريدُ" }
            ]
        },
        {
            p1: [
                { tr: "Tatlılardan", order: 3, ar: "مِن الحَلَوِيّات؟" },
                { tr: "ne", order: 1, ar: "ماذا" },
                { tr: "tercih edersiniz?", order: 2, ar: "تُفَضِّلانِ" }
            ],
            p2: [
                { tr: "Baklava", order: 2, ar: "البَقْلاوة" },
                { tr: "tercih ederiz,", order: 1, ar: "نُفَضِّلُ" },
                { tr: "lütfen.", order: 3, ar: "مِنْ فَضْلِك." }
            ]
        }
    ]
...
window.data.words = [
    ...
    { tr: "Garson", ar: "النّادِل" }, { tr: "Menü", ar: "قائِمة الطَّعام" },
    { tr: "Pirinç", ar: "الأُرْز" }, { tr: "Çorba", ar: "الحَساء" },
    { tr: "Balık", ar: "السَّمَك" }, { tr: "Tavuk", ar: "الدَّجاج" },
    { tr: "Salata", ar: "السَّلَطة" }, { tr: "Ayran, yoğurt", ar: "اللَّبَن" },
    ...
    { tr: "Hava durumu", ar: "الطَّقْس" }, { tr: "Yağmurlu", ar: "مُمْطِر" },
    ...
    { tr: "Buyurun", ar: "تَفَضَّلْ" }, { tr: "Ama, fakat", ar: "لكِنْ" },
