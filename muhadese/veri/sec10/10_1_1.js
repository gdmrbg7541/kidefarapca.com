/* 10. sınıf SEÇMELİ ARAPÇA — 1. Ünite (مِن الحَياة) 1. Ders: الاسْتِعْداد لِلْمَدْرَسة
   Kaynak: Ortaöğretim Seçmeli Arapça ders kitabı, basılı s.10-23.
   Cümleler ve diyalog kitabın kendi metinlerinden alınmıştır; harekeler kitabın
   sayfa görüntülerinden okunmuş, iskeletleri PDF metin katmanıyla doğrulanmıştır.
   Türkçe karşılıklar kitabın sözlüğüne (s.170-181) uygun yazılmıştır. */
window.data = {
    sentence: [
        /* Ben uzun kıyafetler tercih ederim. (s.11) */
        {
            words: [
        ...
        /* Ben kısa kıyafetler tercih etmem. (s.11) */
        {
            words: [
                { tr: "Ben", order: 1, ar: "أَنا" },
        ...
        /* Ben güneşli havayı severim. (s.11) */
        {
            words: [
                { tr: "Ben", order: 1, ar: "أَنا" },
        ...
        /* Kahvaltıda zeytin istiyorum. (s.11) */
        {
            words: [
        ...
        /* Sabah namazını kahvaltıdan önce kılarım. (s.16) */
        {
            words: [
                { tr: "Sabah namazını", order: 2, ar: "صَلاةَ الفَجْرِ" },
                { tr: "kahvaltıdan", order: 4, ar: "الفُطور." },
                { tr: "önce", order: 3, ar: "قَبْلَ" },
                { tr: "kılarım.", order: 1, ar: "أُصَلّي" }
            ]
        },

        /* Kahvaltıdan sonra okula giderim. (s.16) */
        {
            words: [
                { tr: "Kahvaltıdan", order: 4, ar: "الفُطور." },
                { tr: "sonra", order: 3, ar: "بَعْدَ" },
                { tr: "okula", order: 2, ar: "إِلى المَدْرَسةِ" },
                { tr: "giderim.", order: 1, ar: "أَذْهَبُ" }
            ]
        },

        /* O şimdi çantasını hazırlıyor. (s.15) */
        {
            words: [
        ...
        /* O şimdi kıyafetlerini giyiyor. (s.15) */
        {
            words: [
                { tr: "O", order: 1, ar: "هُوَ" },
                { tr: "şimdi", order: 2, ar: "الآنَ" },
                { tr: "kıyafetlerini", order: 4, ar: "مَلابِسَهُ." },
                { tr: "giyiyor.", order: 3, ar: "يَلْبَسُ" }
            ]
        },

        /* O öğleyin eve dönüyor. (s.15) */
        {
            words: [
                { tr: "O", order: 1, ar: "هِيَ" },
                { tr: "öğleyin", order: 4, ar: "ظُهْرًا." },
                { tr: "eve", order: 3, ar: "إِلى البَيْتِ" },
                { tr: "dönüyor.", order: 2, ar: "تَرْجِعُ" }
            ]
        },

        /* Ben namaz için abdest alıyorum. (s.15) */
        {
            words: [
                { tr: "Ben", order: 1, ar: "أَنا" },
        ...
        /* Akşam uyumadan önce kitabımı okurum. (s.16) */
        {
            words: [
    ...
    /* Kitaptaki diyalog: في الفُطور — Fâtıma, annesi ve Hâlid (s.10) */
    dialog: [
        {
            p1: [
        ...
        {
            p1: [
                { tr: "Bugün", order: 4, ar: "اليَوْمَ؟" },
                { tr: "kahvaltıda", order: 3, ar: "في الفُطورِ" },
                { tr: "ne", order: 1, ar: "ماذا" },
                { tr: "istersin?", order: 2, ar: "تُريدينَ" }
            ],
            p2: [
                { tr: "Ben", order: 1, ar: "أَنا" },
        ...
        },
        {
            ...
            p2: [
                { tr: "Kitabın", order: 1, ar: "كِتابُكِ" },
                { tr: "kitaplıkta.", order: 2, ar: "عَلى المَكْتَبة." }
            ]
        },
        {
            p1: [
            ...
            p2: [
                ...
                { tr: "kardeşim!", order: 2, ar: "يا أُخْتي!" }
            ]
        }
    ]
};
