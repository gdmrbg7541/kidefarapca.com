...
window.data = {
    sentence: [
        ...
        /* O karnında ağrı hissediyor. (s.89) */
        {
            words: [
                { tr: "O", order: 1, ar: "هُوَ" },
                { tr: "karnında", order: 4, ar: "في بَطْنِهِ." },
                { tr: "ağrı", order: 3, ar: "بِأَلَمٍ" },
                { tr: "hissediyor.", order: 2, ar: "يَشْعُرُ" }
            ]
        },

        /* Sen ayağında ağrı hissediyorsun. (s.89) */
        {
            words: [
        ...
        /* O hastadır ve nezlesi vardır. (s.90) */
        {
            words: [
                { tr: "O", order: 1, ar: "هُوَ" },
                { tr: "hastadır", order: 2, ar: "مَريضٌ" },
                { tr: "ve nezlesi vardır.", order: 3, ar: "وَعِنْدَهُ نَزْلة." }
            ]
        },

        /* O ikisi hastadır ve karın ağrıları vardır. (s.90) */
        {
            words: [
                { tr: "O ikisi", order: 1, ar: "هُما" },
                { tr: "hastadır", order: 2, ar: "مَريضانِ" },
                { tr: "ve karın ağrıları vardır.", order: 3, ar: "وَعِنْدَهُما مَغْص." }
            ]
        },

        /* Onlar hastaneye gidiyorlar, çünkü nezleleri var. (s.91) */
        {
            words: [
        ...
        /* Hastalığım sebebiyle hastaneye gidiyorum. (s.92) */
        {
            words: [
                { tr: "Hastalığım sebebiyle", order: 3, ar: "بِسَبَبِ مَرَضي." },
                { tr: "hastaneye", order: 2, ar: "إِلى المُسْتَشْفى" },
        ...
        /* Gözümüz sayesinde görürüz. (s.94) */
        {
            words: [
                { tr: "Gözümüz sayesinde", order: 2, ar: "بِفَضْلِ عَيْنِنا." },
                { tr: "görürüz.", order: 1, ar: "نَرى" }
            ]
        },

        /* Burnumuz sayesinde koklarız. (s.94) */
        {
            words: [
        ...
        /* Dilimiz sayesinde tadarız. (s.94) */
        {
            words: [
                { tr: "Dilimiz sayesinde", order: 2, ar: "بِفَضْلِ لِسانِنا." },
                { tr: "tadarız.", order: 1, ar: "نَذوقُ" }
            ]
        },

        /* Bir başımız ve iki ayağımız var. (s.96) */
        {
            words: [
                { tr: "Bizim", order: 1, ar: "لَنا" },
                { tr: "bir başımız", order: 2, ar: "رَأْسٌ واحِدٌ" },
                { tr: "ve iki ayağımız var.", order: 3, ar: "وَقَدَمانِ اثْنَتانِ." }
            ]
        }
    ],

    /* Diyalog: أَنا مَريض ve في المُسْتَشْفى (s.88), أَعْضاء الجِسْم dersi (s.94) */
    dialog: [
        {
            p1: [
                { tr: "Okula", order: 3, ar: "إِلى المَدْرَسة؟" },
        ...
        {
            p1: [
                { tr: "Baş ağrın", order: 2, ar: "صُداع؟" },
                { tr: "var mı?", order: 1, ar: "هَلْ عِنْدَكَ" }
            ],
            p2: [
                { tr: "Evet,", order: 1, ar: "نَعَمْ،" },
                { tr: "baş ağrım var.", order: 2, ar: "عِنْدي صُداع." }
            ]
        },
        {
            p1: [
                { tr: "Hoş geldin,", order: 1, ar: "أَهْلًا وَسَهْلًا،" },
                { tr: "neyin var?", order: 2, ar: "ما بِكَ؟" }
            ],
            p2: [
        ...
        {
            p1: [
                { tr: "Öksürüğün", order: 2, ar: "كُحّة؟" },
                { tr: "var mı?", order: 1, ar: "هَلْ عِنْدَكَ" }
            ],
            p2: [
                { tr: "Evet,", order: 1, ar: "نَعَمْ،" },
                { tr: "öksürüğüm var.", order: 2, ar: "عِنْدي كُحّة." }
            ]
        },
        {
            p1: [
            ...
            p2: [
                { tr: "İnşallah,", order: 1, ar: "إِنْ شاءَ اللهُ،" },
                { tr: "teşekkür ederim", order: 2, ar: "شُكْرًا لَكَ" },
                { tr: "doktor!", order: 3, ar: "يا طَبيب!" }
            ]
        },
        {
            p1: [
                { tr: "Öyleyse,", order: 1, ar: "إِذَنْ،" },
                { tr: "gözün görevi", order: 2, ar: "ما وَظيفةُ العَيْن؟" }
            ],
            p2: [
                { tr: "Gözümüz sayesinde", order: 2, ar: "بِفَضْلِ عَيْنِنا." },
                { tr: "görürüz.", order: 1, ar: "نَرى" }
        ...
        },
        {
            ...
            p2: [
                { tr: "Kulağımızla", order: 2, ar: "بِأُذُنِنا." },
                { tr: "işitiriz.", order: 1, ar: "نَسْمَعُ" }
            ]
        }
    ]
};
...
window.data.words = [
    { tr: "Vücut, beden", ar: "الجِسْم" }, { tr: "Organ, üye", ar: "عُضْو" },
    { tr: "Görev", ar: "وَظيفة" }, { tr: "Kafa, baş", ar: "رَأْس" },
    { tr: "Boğaz", ar: "حَلْق" }, { tr: "Karın", ar: "بَطْن" },
    { tr: "Göz", ar: "عَيْن" }, { tr: "Kulak", ar: "أُذُن" },
    { tr: "Burun", ar: "أَنْف" }, { tr: "Dil", ar: "لِسان" },
    { tr: "El", ar: "يَد" }, { tr: "Ayak", ar: "قَدَم" },
    { tr: "Diş", ar: "سِنّ" }, { tr: "Dişler", ar: "أَسْنان" },
    { tr: "Acı, ağrı", ar: "أَلَم" }, { tr: "Baş ağrısı", ar: "صُداع" },
