...
window.data = {
    sentence: [
        /* Bu ev güzeldir. (s.28) */
        {
            words: [
                ...
                { tr: "ev", order: 2, ar: "البَيْتُ" },
                { tr: "güzeldir.", order: 3, ar: "جَميل." }
            ]
        },

        /* Bu büyük bir ağaçtır. (s.28) */
        {
            words: [
                { tr: "Bu", order: 1, ar: "هذِهِ" },
                { tr: "büyük", order: 3, ar: "كَبيرة." },
                { tr: "bir ağaçtır.", order: 2, ar: "شَجَرة" }
            ]
        },

        /* Bu kitap faydalıdır. (s.28) */
        {
            words: [
                { tr: "Bu", order: 1, ar: "هذا" },
                { tr: "kitap", order: 2, ar: "الكِتابُ" },
                { tr: "faydalıdır.", order: 3, ar: "مُفيد." }
            ]
        },

        /* Bu mühendis hanım beceriklidir. (s.28) */
        {
            words: [
                { tr: "Bu", order: 1, ar: "هذِهِ" },
                { tr: "mühendis hanım", order: 2, ar: "المُهَنْدِسة" },
                { tr: "beceriklidir.", order: 3, ar: "ماهِرة." }
            ]
        },

        /* Bu iki kapı sarıdır. (s.28) */
        {
            words: [
                { tr: "Bu", order: 1, ar: "هذانِ" },
                { tr: "iki kapı", order: 2, ar: "البابانِ" },
                { tr: "sarıdır.", order: 3, ar: "أَصْفَرانِ." }
            ]
        },

        /* Bu iki kız güzeldir. (s.28) */
        {
            words: [
                { tr: "Bu", order: 1, ar: "هاتانِ" },
                { tr: "iki kız", order: 2, ar: "البِنْتانِ" },
                { tr: "güzeldir.", order: 3, ar: "جَميلَتانِ." }
            ]
        },
        ...
        /* Ellerini ve yüzünü banyoda yıkıyor. (s.29) */
        {
            words: [
                { tr: "Ellerini", order: 2, ar: "يَدَيْهِ" },
                { tr: "ve yüzünü", order: 3, ar: "وَوَجْهَهُ" },
                { tr: "banyoda", order: 4, ar: "في الحَمّام." },
                { tr: "yıkıyor.", order: 1, ar: "يَغْسِلُ" }
            ]
        },

        /* Akşam yemeğini ailesiyle yiyor. (s.29) */
        {
            words: [
                { tr: "Akşam yemeğini", order: 2, ar: "العَشاءَ" },
                { tr: "ailesiyle", order: 3, ar: "مَعَ أُسْرَتِهِ." },
                { tr: "yiyor.", order: 1, ar: "يَتَناوَلُ" }
            ]
        },
    ...
    dialog: [
        ...
        {
            p1: [
                { tr: "Bu ikisi", order: 2, ar: "هذانِ" },
                { tr: "kim,", order: 1, ar: "مَنْ" },
                { tr: "Hâlid?", order: 3, ar: "يا خالِد؟" }
            ],
            p2: [
                { tr: "Bunlar", order: 1, ar: "هذانِ" },
                { tr: "Mahmûd ve Eymen,", order: 2, ar: "مَحْمود وَأَيْمَن،" },
                { tr: "onlar", order: 3, ar: "هُما" },
                { tr: "sınıfımda", order: 5, ar: "في صَفّي." },
                { tr: "iki öğrencidir.", order: 4, ar: "طالِبانِ" }
            ]
        }
    ]
};
...
window.data.words = [
    { tr: "Bu (eril)", ar: "هذا" }, { tr: "Bu (dişil)", ar: "هذِهِ" },
    { tr: "Bu ikisi (eril)", ar: "هذانِ" }, { tr: "Bu ikisi (dişil)", ar: "هاتانِ" },
    { tr: "O, şu (eril)", ar: "ذلِكَ" }, { tr: "O, şu (dişil)", ar: "تِلْكَ" },
    { tr: "Gelen, gelecek", ar: "قادِم" }, { tr: "Giden", ar: "ذاهِب" },
    { tr: "Büyük", ar: "كَبير" }, { tr: "Küçük", ar: "صَغير" },
    { tr: "Uzun", ar: "طَويل" }, { tr: "Kısa", ar: "قَصير" },
    ...
    { tr: "Aile", ar: "أُسْرة" }, { tr: "Sınıf", ar: "صَفّ" },
