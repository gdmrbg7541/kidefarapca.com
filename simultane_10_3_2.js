...
sentence :[
    ...
    // 4. İzmir'e arabayla ulaşacağım.
    {
        words: [
            ...
            { tr: "arabayla", order: 3, ar: "بِالسَّيّارَة." },
    ...
    // 5. Kamyon yolda ilerliyor.
    {
        words: [
            ...
            { tr: "yolda", order: 3, ar: "في الطَّريق." },
    ...
    // 8. Bu araba eskidir, ancak şu araba ondan daha eskidir.
    {
        words: [
            ...
            { tr: "araba", order: 2, ar: "السَّيّارَة" },
            { tr: "eskidir,", order: 3, ar: "قَديمَة،" },
            { tr: "ancak", order: 4, ar: "وَلَكِنْ" },
            { tr: "şu", order: 5, ar: "تِلْكَ" },
            { tr: "araba", order: 6, ar: "السَّيّارَة" },
    ...
    // 10. Bu gemi güzeldir, ancak şu gemi ondan daha güzeldir.
    {
        words: [
            { tr: "Bu", order: 1, ar: "هَذِه" },
            { tr: "gemi", order: 2, ar: "السَّفينَة" },
            { tr: "güzeldir,", order: 3, ar: "جَميلَة،" },
            { tr: "ancak", order: 4, ar: "وَلَكِنْ" },
            { tr: "şu", order: 5, ar: "تِلْكَ" },
            { tr: "gemi", order: 6, ar: "السَّفينَة" },
            { tr: "ondan", order: 8, ar: "مِنْها." },
    ...
    // 11. Uçak havalimanına saat yediyi çeyrek geçe ulaştı.
    {
        words: [
            ...
            { tr: "çeyrek geçe", order: 6, ar: "وَالرُّبْع." },
    ...
    {
        words: [
            { tr: "Hızlı", order: 3, ar: "السَّريع" },
            { tr: "tren", order: 2, ar: "القِطار" },
            { tr: "istasyona", order: 4, ar: "إِلى المَحَطَّة" },
            { tr: "saat", order: 5, ar: "في السّاعَة" },
    ...
    { words: [{ tr: "Saat", order: 1, ar: "السّاعَة" }, { tr: "beşi", order: 2, ar: "الخامِسَة" }, { tr: "yirmi geçiyor.", order: 3, ar: "وَالثُّلُث" }] },
    ...
    { words: [{ tr: "Saat", order: 1, ar: "السّاعَة" }, { tr: "onu", order: 2, ar: "العاشِرَة" }, { tr: "çeyrek geçiyor.", order: 3, ar: "وَالرُّبْع" }] },
    // 19. Saat beşi çeyrek geçiyor.
    { words: [{ tr: "Saat", order: 1, ar: "السّاعَة" }, { tr: "beşi", order: 2, ar: "الخامِسَة" }, { tr: "çeyrek geçiyor.", order: 3, ar: "وَالرُّبْع" }] },
    ...
    { words: [{ tr: "Saat", order: 1, ar: "السّاعَة" }, { tr: "biri", order: 2, ar: "الواحِدَة" }, { tr: "yirmi geçiyor.", order: 3, ar: "وَالثُّلُث" }] },
    ...
    { words: [{ tr: "Saat", order: 1, ar: "السّاعَة" }, { tr: "üçü", order: 2, ar: "الثّالِثَة" }, { tr: "yirmi geçiyor.", order: 3, ar: "وَالثُّلُث" }] },
    ...
    { words: [{ tr: "Saat", order: 1, ar: "السّاعَة" }, { tr: "yediyi", order: 2, ar: "السّابِعَة" }, { tr: "çeyrek geçiyor.", order: 3, ar: "وَالرُّبْع" }] },
    ...
    // 29. Biraz yürü ve sağa yönel.
    {
        words: [
            ...
            { tr: "yönel.", order: 3, ar: "وَاتَّجَهْ" }
        ]
    },
    ...
    // 32. Araba kırmızı ışıkta duruyor.
    {
        words: [
            ...
            { tr: "ışıkta", order: 3, ar: "عِنْد الضَّوْء" },
    ...
    // 33. Sürücü sarı ışıkta gitmek için hazırlanıyor.
    {
        words: [
            ...
            { tr: "ışıkta", order: 4, ar: "عِنْد الضَّوْء" },
            { tr: "gitmek için", order: 3, ar: "لِلسَّيْر" },
            { tr: "hazırlanıyor.", order: 1, ar: "يَسْتَعِدُّ" }
        ]
    },
    ...
    // 36. Kırmızı ışıkta duruyorum.
    {
        words: [
            ...
            { tr: "ışıkta", order: 2, ar: "عِنْد الضَّوْء" },
    ...
    // 41. Her sabah saat yediyi çeyrek geçe evimden çıkıyorum.
    {
        words: [
            ...
            { tr: "çeyrek geçe", order: 5, ar: "وَالرُّبْع" },
    ...
    // 43. Yeni eczanenin önünde otobüsten iniyorum.
    {
        words: [
            ...
            { tr: "eczanenin", order: 4, ar: "الصَّيْدَلِيَّة" },
    ...
    // 45. Caminin yanında sola yöneliyorum.
    {
        words: [
            ...
            { tr: "sola", order: 2, ar: "إِلى اليَسار" },
            { tr: "yöneliyorum.", order: 1, ar: "أَتَّجِهُ" }
        ]
    },
...
dialog :[
    ...
    },
    {
        p1: [
            ...
            { tr: "gitmek", order: 3, ar: "الذَّهَاب؟" },
            { tr: "istiyorsun?", order: 2, ar: "تُرِيدُ" }
        ],
        p2: [
            { tr: "İstanbul'a", order: 3, ar: "إِلَى إِسْطَنْبُول." },
            { tr: "gitmek", order: 2, ar: "الذَّهَابَ" },
            { tr: "istiyorum.", order: 1, ar: "أُرِيدُ" }
        ]
    },
    {
    ...
    {
        p1: [
            { tr: "Yolculuk", order: 4, ar: "الرِّحْلَة؟" },
    ...
    },
    {
        p1: [
            ...
            { tr: "sağ salim", order: 2, ar: "بِالسَّلَامَة" },
    ...
    {
        p1: [
            { tr: "Selamun aleyküm.", order: 1, ar: "السَّلَامُ عَلَيْكُمْ." },
            { tr: "Marmara", order: 5, ar: "مَرْمَرَة." },
            { tr: "oteline", order: 4, ar: "إِلَى فُنْدُقِ" },
            { tr: "gitmek", order: 3, ar: "الذَّهَابَ" },
            { tr: "istiyorum.", order: 2, ar: "أُرِيدُ" }
        ],
        p2: [
            { tr: "Ve aleyküm selam.", order: 1, ar: "وَعَلَيْكُمُ السَّلَام." },
    ...
    },
    {
        ...
        p2: [
            ...
            { tr: "yönel.", order: 3, ar: "وَاتَّجِهْ" },
    ...
    },
    {
        p1: [
            ...
            { tr: "efendim,", order: 2, ar: "يَا سَيِّدِي،" },
    ...
    },
    {
        ...
        p2: [
            ...
            { tr: "caddede", order: 6, ar: "فِي الشَّارِعِ" },
            { tr: "biraz", order: 8, ar: "قَلِيلًا،" },
            { tr: "yürü,", order: 5, ar: "وَامْشِي" },
            { tr: "sonra", order: 9, ar: "ثُمَّ" },
            { tr: "sola", order: 11, ar: "إِلَى الْيَسَار." },
            { tr: "yönel.", order: 10, ar: "اتَّجِهِي" }
        ]
    },
    {
        p1: [
    ...
    // --- 5. DİYALOG: CAMİ YOL TARİFİ ---
    {
        ...
        p2: [
            { tr: "Ve aleykum selam,", order: 1, ar: "وَعَلَيْكُمُ السَّلَام،" },
            { tr: "otobüse", order: 3, ar: "الْحَافِلَةَ" },
            { tr: "bin", order: 2, ar: "اِرْكَبِ" },
            { tr: "merkez", order: 6, ar: "السُّوقِ الْمَرْكَزِيّ." },
    ...
    },
    {
        p1: [
            ...
            { tr: "çünkü o", order: 2, ar: "لِأَنَّهُ" },
    ...
    // --- 6. DİYALOG: OTOBÜS DURAĞI YOL TARİFİ ---
    {
        ...
        p2: [
            ...
            { tr: "yürü,", order: 1, ar: "اِمْشِ" },
            { tr: "sonra", order: 4, ar: "ثُمَّ" },
            { tr: "sola", order: 6, ar: "إِلَى الْيَسَار." },
            { tr: "yönel.", order: 5, ar: "اتَّجِهْ" },
